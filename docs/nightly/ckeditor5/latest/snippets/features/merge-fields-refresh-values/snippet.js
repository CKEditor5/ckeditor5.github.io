var T="https://33333.cke-cs.com/token/dev/ijrDsqFix838Gh3wGO3F77FSW94BwcLXprJ4APSp3XQ26xsUHTi0jcb1hoBt",w="https://33333.cke-cs.com/easyimage/upload/",I="33333.cke-cs.com/ws",m={tokenUrl:T,uploadUrl:w,webSocketUrl:I};var g="https://api.ckbox.io/token/demo";import{Plugin as et}from"@ckeditor/ckeditor5-core";import{Essentials as ot}from"@ckeditor/ckeditor5-essentials";import{Autoformat as it}from"@ckeditor/ckeditor5-autoformat";import{BlockQuote as lt}from"@ckeditor/ckeditor5-block-quote";import{Bold as nt,Italic as dt}from"@ckeditor/ckeditor5-basic-styles";import{Heading as pt}from"@ckeditor/ckeditor5-heading";import{Image as gt,ImageCaption as ut,ImageStyle as ft,ImageToolbar as bt}from"@ckeditor/ckeditor5-image";import{Indent as yt}from"@ckeditor/ckeditor5-indent";import{Link as kt}from"@ckeditor/ckeditor5-link";import{List as wt}from"@ckeditor/ckeditor5-list";import{MediaEmbed as St}from"@ckeditor/ckeditor5-media-embed";import{Paragraph as Ct}from"@ckeditor/ckeditor5-paragraph";import{Table as Lt,TableToolbar as Pt}from"@ckeditor/ckeditor5-table";function u({id:e,target:t,text:a,editor:i,tippyOptions:p}){if(!t){console.warn("[attachTourBalloon] The target DOM node for the feature tour balloon does not exist.",{text:a});return}if(!t.offsetParent){console.warn("[attachTourBalloon] The target DOM node is invisible and the balloon could not be attached.",{target:t,text:a});return}let s=window.umberto.Tooltip.create({id:e,text:a,trigger:t,mode:"click",variant:"dark",icon:"bulb",disableOnMobile:!1,showCloseButton:!0,showAfterMount:!0,hideOnOutsideClick:!1,destroyOnHide:!0,...p?.placement&&{position:p.placement}});for(let x of i.editing.view.document.roots)x.once("change:isFocused",(ze,We,k)=>{k&&s.destroy()});return s}function f(e,t){let a=e.items,i;return typeof t=="function"?i=a.find(t):i=a.get(t),i?i.element:void 0}function b(){let e=document.documentElement;return parseInt(window.getComputedStyle(e).getPropertyValue("--ck-snippet-viewport-top-offset"))}import{BalloonEditor as Ot,Essentials as At,Autoformat as Nt,BlockToolbar as Mt,Bold as Vt,Italic as Ut,BlockQuote as Gt,CKBox as Kt,Heading as Ht,Image as qt,ImageCaption as Qt,ImageStyle as Xt,ImageToolbar as zt,ImageUpload as Wt,PictureEditing as jt,Indent as Jt,IndentBlock as $t,Link as Yt,List as Zt,MediaEmbed as eo,Paragraph as to,PasteFromOffice as oo,Table as ao,TableToolbar as io,TextTransformation as ro,CloudServices as lo}from"ckeditor5";import{BalloonEditor as po,Essentials as mo,Autoformat as go,Bold as uo,Italic as fo,BlockQuote as bo,CKBox as ho,Heading as yo,Image as xo,ImageCaption as ko,ImageStyle as To,ImageToolbar as wo,ImageUpload as Io,PictureEditing as So,Indent as vo,IndentBlock as Co,Link as Eo,List as Lo,MediaEmbed as Po,Paragraph as _o,PasteFromOffice as Bo,Table as Do,TableToolbar as Ro,TextTransformation as Fo,CloudServices as Oo}from"ckeditor5";import{ClassicEditor as S,Essentials as v,Autoformat as C,Bold as E,Italic as L,BlockQuote as P,CKBox as _,Heading as B,Image as D,ImageCaption as R,ImageStyle as F,ImageToolbar as O,ImageUpload as A,PictureEditing as N,Indent as M,IndentBlock as V,Link as U,List as G,MediaEmbed as K,Paragraph as H,PasteFromOffice as q,Table as Q,TableToolbar as X,TextTransformation as z,CloudServices as W,AutoImage as j,ImageInsert as J,Bookmark as $}from"ckeditor5";var r=class extends S{static builtinPlugins=[v,C,E,L,P,W,B,D,R,F,O,A,_,M,V,U,G,K,H,q,N,Q,X,z,j,J,$];static defaultConfig={toolbar:{items:["undo","redo","|","heading","|","bold","italic","|","link","uploadImage","insertTable","blockQuote","mediaEmbed","|","bulletedList","numberedList","outdent","indent"]},image:{toolbar:["imageStyle:inline","imageStyle:block","imageStyle:wrapText","|","toggleImageCaption","imageTextAlternative"]},table:{contentToolbar:["tableColumn","tableRow","mergeTableCells"]},list:{enableSkipLevelLists:!0},language:"en"}};import{DecoupledEditor as Ko,Essentials as Ho,Alignment as qo,FontSize as Qo,FontFamily as Xo,FontColor as zo,FontBackgroundColor as Wo,Autoformat as jo,Bold as Jo,Italic as $o,Strikethrough as Yo,Underline as Zo,BlockQuote as ea,CKBox as ta,Heading as oa,Image as aa,ImageCaption as ia,ImageResize as ra,ImageStyle as la,ImageToolbar as sa,ImageUpload as na,PictureEditing as da,Indent as ca,IndentBlock as pa,Link as ma,List as ga,ListProperties as ua,MediaEmbed as fa,Paragraph as ba,PasteFromOffice as ha,Table as ya,TableToolbar as xa,TextTransformation as ka,CloudServices as Ta}from"ckeditor5";import{InlineEditor as va,Essentials as Ca,Autoformat as Ea,Bold as La,Italic as Pa,BlockQuote as _a,CKBox as Ba,Heading as Da,Image as Ra,ImageCaption as Fa,ImageStyle as Oa,ImageToolbar as Aa,ImageUpload as Na,PictureEditing as Ma,Indent as Va,IndentBlock as Ua,Link as Ga,List as Ka,MediaEmbed as Ha,Paragraph as qa,PasteFromOffice as Qa,Table as Xa,TableToolbar as za,TextTransformation as Wa,CloudServices as ja}from"ckeditor5";import{MultiRootEditor as Za,Essentials as ei,Autoformat as ti,Bold as oi,Italic as ai,BlockQuote as ii,CKBox as ri,Heading as li,Image as si,ImageCaption as ni,ImageStyle as di,ImageToolbar as ci,ImageUpload as pi,PictureEditing as mi,Indent as gi,IndentBlock as ui,Link as fi,List as bi,MediaEmbed as hi,Paragraph as yi,PasteFromOffice as xi,Table as ki,TableToolbar as Ti,TextTransformation as wi,CloudServices as Ii}from"ckeditor5";import{Alignment as Y,Autoformat as Z,Bold as ee,Italic as te,Underline as oe,BlockQuote as ae,CKBox as ie,CKBoxImageEdit as re,CloudServices as le,Essentials as se,FontBackgroundColor as ne,FontColor as de,FontFamily as ce,FontSize as pe,Heading as me,Indent as ge,IndentBlock as ue,PictureEditing as fe,Image as be,ImageCaption as he,ImageInsert as ye,ImageResize as xe,ImageStyle as ke,ImageToolbar as Te,ImageUpload as we,Link as Ie,List as Se,MediaEmbed as ve,PageBreak as Ce,Paragraph as Ee,PasteFromOffice as Le,SpecialCharacters as Pe,SpecialCharactersEssentials as _e,Table as Be,TableCellProperties as De,TableProperties as Re,TableToolbar as Fe,TextTransformation as Oe,CodeBlock as Ae,Mention as Ne,Plugin as Me}from"ckeditor5";import{SourceEditingEnhanced as Ve,ExportPdf as Ue,ExportWord as Ge,ImportWord as Ke,MergeFields as He,Template as qe}from"ckeditor5-premium-features";var n="19.25mm",d="16mm",l=class extends r{static builtinPlugins=[...r.builtinPlugins,He,Ne,Y,se,Z,ae,ee,ie,re,Ae,me,fe,be,he,ke,Te,ge,te,Ie,Se,Ee,Be,Fe,Ue,Ge,Ke,pe,ce,de,ne,ue,we,ye,xe,ve,Ce,Le,Pe,_e,Ve,Re,De,Oe,oe,le,qe];static defaultConfig={mergeFields:{prefix:"{{",suffix:"}}",previewHtmlValues:!0,sanitizeHtml:t=>({html:t,hasChanged:!1}),definitions:[{groupId:"guestInformation",groupLabel:"Guest information",definitions:[{id:"guestTitle",label:"Title",defaultValue:"Mr./Mrs."},{id:"guestName",label:"Name",defaultValue:"John"},{id:"guestLastName",label:"Last name",defaultValue:"Doe"},{id:"discount",label:"Guest discount",defaultValue:"0%"},{id:"hotelRoomPhoto",label:"Hotel room photo",type:"image",width:600,height:400,defaultValue:"https://ckeditor.com/assets/images/ckdemo/merge-fields/hotel-room2.jpg"}]},{groupId:"reservationInformation",groupLabel:"Reservation information",definitions:[{id:"reservationNumber",label:"Reservation number",defaultValue:"0000"},{id:"arrivalDate",label:"Arrival date",defaultValue:()=>new Date().toLocaleDateString()},{id:"numberOfNights",label:"Number of nights",defaultValue:"0"},{id:"numberOfGuests",label:"Number of guests",defaultValue:"0"},{id:"roomType",label:"Room type",defaultValue:"Single room"},{id:"complimentaryDuration",label:"Complimentary duration",defaultValue:"60 min"},{id:"reservationDetails",label:"Reservation details",defaultValue:`
