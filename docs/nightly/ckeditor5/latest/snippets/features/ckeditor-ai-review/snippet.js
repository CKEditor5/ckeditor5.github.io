import{Alignment as K,Autoformat as F,AutoImage as V,AutoLink as Q,Autosave as j,BalloonToolbar as G,BlockQuote as $,Bold as M,Bookmark as J,CKBox as Z,CKBoxImageEdit as X,CloudServices as Y,Code as ee,DecoupledEditor as te,Emoji as oe,Essentials as re,FindAndReplace as ie,FontBackgroundColor as ae,FontColor as ne,FontFamily as le,FontSize as se,Fullscreen as de,GeneralHtmlSupport as ce,Heading as me,HorizontalLine as pe,ImageBlock as ue,ImageCaption as ge,ImageEditing as he,ImageInline as fe,ImageInsert as be,ImageInsertViaUrl as ye,ImageResize as ke,ImageStyle as we,ImageTextAlternative as ve,ImageToolbar as Ce,ImageUpload as Ie,ImageUtils as Te,Indent as xe,IndentBlock as Se,Italic as D,Link as Ae,LinkImage as Ee,List as Le,ListProperties as Be,Mention as _e,Paragraph as Pe,PasteFromOffice as Fe,PictureEditing as Me,Plugin as De,RemoveFormat as Ue,SpecialCharacters as Re,SpecialCharactersArrows as Oe,SpecialCharactersCurrency as qe,SpecialCharactersEssentials as He,SpecialCharactersLatin as We,SpecialCharactersMathematical as Ne,SpecialCharactersText as ze,Strikethrough as Ke,Subscript as Ve,Superscript as Qe,Table as je,TableCaption as Ge,TableCellProperties as $e,TableColumnResize as Je,TableProperties as Ze,TableToolbar as Xe,TextTransformation as Ye,TodoList as et,Underline as tt}from"ckeditor5";var q="https://33333.cke-cs.com/token/dev/ijrDsqFix838Gh3wGO3F77FSW94BwcLXprJ4APSp3XQ26xsUHTi0jcb1hoBt",H="https://33333.cke-cs.com/easyimage/upload/",W="33333.cke-cs.com/ws",y={tokenUrl:q,uploadUrl:H,webSocketUrl:W};var w="https://api.ckbox.io/token/demo";import{Plugin as Ut}from"@ckeditor/ckeditor5-core";import{Essentials as Ot}from"@ckeditor/ckeditor5-essentials";import{Autoformat as Ht}from"@ckeditor/ckeditor5-autoformat";import{BlockQuote as Nt}from"@ckeditor/ckeditor5-block-quote";import{Bold as Kt,Italic as Vt}from"@ckeditor/ckeditor5-basic-styles";import{Heading as jt}from"@ckeditor/ckeditor5-heading";import{Image as $t,ImageCaption as Jt,ImageStyle as Zt,ImageToolbar as Xt}from"@ckeditor/ckeditor5-image";import{Indent as eo}from"@ckeditor/ckeditor5-indent";import{Link as oo}from"@ckeditor/ckeditor5-link";import{List as io}from"@ckeditor/ckeditor5-list";import{MediaEmbed as no}from"@ckeditor/ckeditor5-media-embed";import{Paragraph as so}from"@ckeditor/ckeditor5-paragraph";import{Table as mo,TableToolbar as po}from"@ckeditor/ckeditor5-table";function v(){let t=document.documentElement;return parseInt(window.getComputedStyle(t).getPropertyValue("--ck-snippet-viewport-top-offset"))}function k(t){return document.querySelector(`link[href*="${t}/snippet.css"][data-cke]`)?.href||""}import{BalloonEditor as yo,Essentials as ko,Autoformat as wo,BlockToolbar as vo,Bold as Co,Italic as Io,BlockQuote as To,CKBox as xo,Heading as So,Image as Ao,ImageCaption as Eo,ImageStyle as Lo,ImageToolbar as Bo,ImageUpload as _o,PictureEditing as Po,Indent as Fo,IndentBlock as Mo,Link as Do,List as Uo,MediaEmbed as Ro,Paragraph as Oo,PasteFromOffice as qo,Table as Ho,TableToolbar as Wo,TextTransformation as No,CloudServices as zo}from"ckeditor5";import{BalloonEditor as jo,Essentials as Go,Autoformat as $o,Bold as Jo,Italic as Zo,BlockQuote as Xo,CKBox as Yo,Heading as er,Image as tr,ImageCaption as or,ImageStyle as rr,ImageToolbar as ir,ImageUpload as ar,PictureEditing as nr,Indent as lr,IndentBlock as sr,Link as dr,List as cr,MediaEmbed as mr,Paragraph as pr,PasteFromOffice as ur,Table as gr,TableToolbar as hr,TextTransformation as fr,CloudServices as br}from"ckeditor5";import{ClassicEditor as vr,Essentials as Cr,Autoformat as Ir,Bold as Tr,Italic as xr,BlockQuote as Sr,CKBox as Ar,Heading as Er,Image as Lr,ImageCaption as Br,ImageStyle as _r,ImageToolbar as Pr,ImageUpload as Fr,PictureEditing as Mr,Indent as Dr,IndentBlock as Ur,Link as Rr,List as Or,MediaEmbed as qr,Paragraph as Hr,PasteFromOffice as Wr,Table as Nr,TableToolbar as zr,TextTransformation as Kr,CloudServices as Vr,AutoImage as Qr,ImageInsert as jr,Bookmark as Gr}from"ckeditor5";import{DecoupledEditor as Xr,Essentials as Yr,Alignment as ei,FontSize as ti,FontFamily as oi,FontColor as ri,FontBackgroundColor as ii,Autoformat as ai,Bold as ni,Italic as li,Strikethrough as si,Underline as di,BlockQuote as ci,CKBox as mi,Heading as pi,Image as ui,ImageCaption as gi,ImageResize as hi,ImageStyle as fi,ImageToolbar as bi,ImageUpload as yi,PictureEditing as ki,Indent as wi,IndentBlock as vi,Link as Ci,List as Ii,ListProperties as Ti,MediaEmbed as xi,Paragraph as Si,PasteFromOffice as Ai,Table as Ei,TableToolbar as Li,TextTransformation as Bi,CloudServices as _i}from"ckeditor5";import{InlineEditor as Di,Essentials as Ui,Autoformat as Ri,Bold as Oi,Italic as qi,BlockQuote as Hi,CKBox as Wi,Heading as Ni,Image as zi,ImageCaption as Ki,ImageStyle as Vi,ImageToolbar as Qi,ImageUpload as ji,PictureEditing as Gi,Indent as $i,IndentBlock as Ji,Link as Zi,List as Xi,MediaEmbed as Yi,Paragraph as ea,PasteFromOffice as ta,Table as oa,TableToolbar as ra,TextTransformation as ia,CloudServices as aa}from"ckeditor5";import{MultiRootEditor as da,Essentials as ca,Autoformat as ma,Bold as pa,Italic as ua,BlockQuote as ga,CKBox as ha,Heading as fa,Image as ba,ImageCaption as ya,ImageStyle as ka,ImageToolbar as wa,ImageUpload as va,PictureEditing as Ca,Indent as Ia,IndentBlock as Ta,Link as xa,List as Sa,MediaEmbed as Aa,Paragraph as Ea,PasteFromOffice as La,Table as Ba,TableToolbar as _a,TextTransformation as Pa,CloudServices as Fa}from"ckeditor5";import{AIChat as ot,AIEditorIntegration as rt,AIQuickActions as it,AIReviewMode as at,AITranslate as nt,CaseChange as lt,Comments as st,CommentsRepository as dt,ExportPdf as ct,ExportWord as mt,Footnotes as pt,FormatPainter as ut,ImportWord as gt,LineHeight as ht,MergeFields as ft,MultiLevelList as bt,PasteFromOfficeEnhanced as yt,SlashCommand as kt,TableOfContents as wt,Template as vt,TrackChanges as Ct,TrackChangesData as It,TrackChangesPreview as Tt,Users as xt}from"ckeditor5-premium-features";import{uid as N}from"ckeditor5";function E(){let t=["Bo","Jo","Moe","Mex","Tex","Hex","Brick","Em","Plate","Zee","DJ","CJ","AJ"],r=["King","Egli","Zwart","Principe","Siddiqui","Ehlers","Coltrane","Grimes","Cavallaro","Croce","Haddox","Weatherspoon","Gilpatrick","Funderburk","Mustard","Enterline","Redden","Hayford","Hevey","Dey","Demaio","Chenard","Whalley","Light","Kleist","Huntsman","Drovin","Duenes","Weintraub","Mcbeath","Harden","Streicher","Nadel","Philbrick","Ramm","Byrge","Broce","Olivera","Hamm","Tweedie","Hershman","Hertzler","Fielding","Dao","Constante","Berens","Finks","Corvin","Lemmons","Cuenca"],o=N(),e=t[Math.floor(Math.random()*t.length)],i=r[Math.floor(Math.random()*r.length)];return{name:e+" "+i,id:o}}function L(t,r=E()){return`${t}?`+Object.keys(r).filter(e=>r[e]).map(e=>`user.${e}=${r[e]}`).join("&")}function B(t){t.plugins.has("AIErrorSink")&&t.plugins.get("AIErrorSink").on("error",(r,{error:o,component:e,code:i,type:l,severity:s,context:d})=>{typeof window.Sentry>"u"||l==="user"||l==="network"||window.Sentry.captureException(o,{tags:{component:e,errorCode:i,errorType:l},level:s==="warning"?"warning":"error",extra:d})})}function _(t){t.commands.get("aiQuickAction")&&t.commands.get("aiQuickAction").on("execute",(o,e)=>{e[0].type==="CHAT"&&(t.commands.get("toggleAi").value||t.execute("toggleAi"))},{priority:"high"})}function P(t,r,{signal:o,edges:e}={}){let i,l=null,s=e!=null&&e.includes("leading"),d=e==null||e.includes("trailing"),c=()=>{l!==null&&(t.apply(i,l),i=void 0,l=null)},m=()=>{d&&c(),g()},n=null,u=()=>{n!=null&&clearTimeout(n),n=setTimeout(()=>{n=null,m()},r)},p=()=>{n!==null&&(clearTimeout(n),n=null)},g=()=>{p(),i=void 0,l=null},f=()=>{c()},b=function(...R){if(o?.aborted)return;i=this,l=R;let O=n==null;u(),s&&O&&c()};return b.schedule=u,b.cancel=g,b.flush=f,o?.addEventListener("abort",g,{once:!0}),b}function C(t,r=0,o={}){typeof o!="object"&&(o={});let{leading:e=!1,trailing:i=!0,maxWait:l}=o,s=Array(2);e&&(s[0]="leading"),i&&(s[1]="trailing");let d,c=null,m=P(function(...p){d=t.apply(this,p),c=null},r,{edges:s}),n=function(...p){return l!=null&&(c===null&&(c=Date.now()),Date.now()-c>=l)?((e||i)&&(d=t.apply(this,p)),c=Date.now(),m.cancel(),m.schedule(),d):(m.apply(this,p),d)},u=()=>(m.flush(),d);return n.cancel=m.cancel,n.flush=u,n}function I(t){t.on("ready",()=>{let r=t.plugins.get("AnnotationsUIs"),o=t.commands.get("toggleFullscreen"),e=document.querySelector(".editing-area-scroll-wrapper"),i=parseFloat(window.getComputedStyle(document.documentElement).getPropertyValue("--ck-demo-sidebar-wide-min-width"));if(isNaN(parseFloat(i))){console.error("--ck-demo-sidebar-wide-min-width is required by DynamicAnnotationsModeIntegration");return}let l=new Map([[document.querySelector(".editing-area-scroll-wrapper .ck.editor-content"),["margin-left","margin-right","border-left-width","border-right-width","scrollWidth"]],[document.querySelector(".editing-area-scroll-wrapper .editor-content-wrapper"),["padding-left","padding-right"]]]),s=C(()=>{if(!(o&&o.value))if(e.scrollWidth>e.clientWidth)m("narrowSidebar");else{let n=0;l.forEach((u,p)=>{let g=getComputedStyle(p);for(let f of u)f==="scrollWidth"?n+=p.scrollWidth:n+=parseFloat(g.getPropertyValue(f))||0}),n+i<e.clientWidth&&m("wideSidebar")}},10),d=new ResizeObserver(s);d.observe(e),d.observe(document.querySelector(".editor-content-wrapper")),o&&o.on("execute",()=>{o.value||s()}),s();let c="wideSidebar";function m(n){c!==n&&(r.switchTo(n),c=n)}})}function T(){let t=document.querySelectorAll(".live-snippet"),r=[];return t.forEach(o=>{let e=o.querySelector(".live-snippet__container");if(!e)return;let i=document.createElement("div");i.classList.add("live-snippet__loader"),i.innerHTML=`<svg class="spinner" viewBox="25 25 50 50">
				<circle class="path" cx="50" cy="50" r="20" fill="none" stroke-width="2" stroke-miterlimit="10"></circle>
			</svg>`,o.prepend(i),r.push({container:e,spinner:i,markDemoAsLoaded(){i.classList.add("fadeout"),e.classList.add("loaded")}})}),r}import{uid as z}from"ckeditor5";function x(t){let r=location.search.match(new RegExp(`${t}=([^&]+)`)),o=r?decodeURIComponent(r[1]):null;if(!o){o=z();let e=new URL(window.location.href);e.searchParams.set(t,o),window.history.replaceState({},document.title,e.toString())}return o}var St=x("channelId"),h=x("userId"),S={name:Et(),id:h,role:"writer"},A=class extends De{static get requires(){return[xt,dt]}init(){let r=this.editor.plugins.get("Users"),o=this.editor.plugins.get("CommentsRepository");r.addUser(S),r.defineMe(S.id),o.adapter={addComment:()=>Promise.resolve(),updateComment:()=>Promise.resolve(),removeComment:()=>Promise.resolve(),getCommentThread:({threadId:e})=>{let i={"thread-1":{threadId:"thread-1",comments:[{commentId:"comment-1",authorId:h,content:"<p>What are some typical examples of Tier 2 cases?</p>",createdAt:new Date}]},"thread-2":{threadId:"thread-2",comments:[{commentId:"comment-1",authorId:h,content:"<p>Could we add one sentence explaining what qualifies as \u201Chigh-impact\u201D?</p>",createdAt:new Date}]},"thread-3":{threadId:"thread-3",comments:[{commentId:"comment-1",authorId:h,content:"<p>Can we add percentages for each category?</p>",createdAt:new Date}]},"thread-4":{threadId:"thread-4",comments:[{commentId:"comment-1",authorId:h,content:"<p>Can we add a short explanation here?</p>",createdAt:new Date}]}};return Promise.resolve(i[e])},addCommentThread:()=>Promise.resolve({comments:[]}),updateCommentThread:()=>Promise.resolve(),resolveCommentThread:()=>Promise.resolve({resolvedAt:new Date,resolvedBy:r.me.id}),reopenCommentThread:()=>Promise.resolve(),removeCommentThread:()=>Promise.resolve()}}},At=`<h1>Customer Support Metrics Report</h1>
