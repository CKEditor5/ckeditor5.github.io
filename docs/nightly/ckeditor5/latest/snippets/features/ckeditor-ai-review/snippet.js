var j=Object.create;var _=Object.defineProperty;var J=Object.getOwnPropertyDescriptor;var G=Object.getOwnPropertyNames;var $=Object.getPrototypeOf,Z=Object.prototype.hasOwnProperty;var X=(e,o,r)=>()=>{if(r)throw r[0];try{return e&&(o=e(e=0)),o}catch(t){throw r=[t],t}};var v=(e,o)=>()=>{try{return o||e((o={exports:{}}).exports,o),o.exports}catch(r){throw o=0,r}};var Y=(e,o,r,t)=>{if(o&&typeof o=="object"||typeof o=="function")for(let n of G(o))!Z.call(e,n)&&n!==r&&_(e,n,{get:()=>o[n],enumerable:!(t=J(o,n))||t.enumerable});return e};var ee=(e,o,r)=>(r=e!=null?j($(e)):{},Y(o||!e||!e.__esModule?_(r,"default",{value:e,enumerable:!0}):r,e));var i=X(()=>{});var D=v(T=>{"use strict";i();Object.defineProperty(T,Symbol.toStringTag,{value:"Module"});function ne(e,o,{signal:r,edges:t}={}){let n,s=null,d=t!=null&&t.includes("leading"),c=t==null||t.includes("trailing"),m=()=>{s!==null&&(e.apply(n,s),n=void 0,s=null)},u=()=>{c&&m(),h()},l=null,g=()=>{l!=null&&clearTimeout(l),l=setTimeout(()=>{l=null,u()},o)},p=()=>{l!==null&&(clearTimeout(l),l=null)},h=()=>{p(),n=void 0,s=null},b=()=>{m()},y=function(...V){if(r?.aborted)return;n=this,s=V;let Q=l==null;g(),d&&Q&&m()};return y.schedule=g,y.cancel=h,y.flush=b,r?.addEventListener("abort",h,{once:!0}),y}T.debounce=ne});var R=v(x=>{"use strict";i();Object.defineProperty(x,Symbol.toStringTag,{value:"Module"});var ae=D();function le(e,o=0,r={}){typeof r!="object"&&(r={});let{leading:t=!1,trailing:n=!0,maxWait:s}=r,d=Array(2);t&&(d[0]="leading"),n&&(d[1]="trailing");let c,m=null,u=ae.debounce(function(...p){c=e.apply(this,p),m=null},o,{edges:d}),l=function(...p){return s!=null&&(m===null&&(m=Date.now()),Date.now()-m>=s)?(c=e.apply(this,p),m=Date.now(),u.cancel(),u.schedule(),c):(u.apply(this,p),c)},g=()=>(u.flush(),c);return l.cancel=u.cancel,l.flush=g,l}x.debounce=le});var q=v((Na,O)=>{i();O.exports=R().debounce});i();i();import{Alignment as de,Autoformat as W,AutoImage as ce,AutoLink as me,Autosave as ue,BalloonToolbar as pe,BlockQuote as ge,Bold as N,Bookmark as he,CKBox as fe,CKBoxImageEdit as be,CloudServices as ye,Code as ke,DecoupledEditor as we,Emoji as ve,Essentials as Ce,FindAndReplace as Ie,FontBackgroundColor as Te,FontColor as xe,FontFamily as Se,FontSize as Ae,Fullscreen as Ee,GeneralHtmlSupport as Le,Heading as Be,HorizontalLine as _e,ImageBlock as Pe,ImageCaption as Fe,ImageEditing as Me,ImageInline as Ue,ImageInsert as De,ImageInsertViaUrl as Re,ImageResize as Oe,ImageStyle as qe,ImageTextAlternative as He,ImageToolbar as We,ImageUpload as Ne,ImageUtils as ze,Indent as Ke,IndentBlock as Ve,Italic as z,Link as Qe,LinkImage as je,List as Je,ListProperties as Ge,Mention as $e,Paragraph as Ze,PasteFromOffice as Xe,PictureEditing as Ye,Plugin as et,RemoveFormat as tt,SpecialCharacters as ot,SpecialCharactersArrows as rt,SpecialCharactersCurrency as it,SpecialCharactersEssentials as nt,SpecialCharactersLatin as at,SpecialCharactersMathematical as lt,SpecialCharactersText as st,Strikethrough as dt,Subscript as ct,Superscript as mt,Table as ut,TableCaption as pt,TableCellProperties as gt,TableColumnResize as ht,TableProperties as ft,TableToolbar as bt,TextTransformation as yt,TodoList as kt,Underline as wt}from"ckeditor5";i();i();var te="https://33333.cke-cs.com/token/dev/ijrDsqFix838Gh3wGO3F77FSW94BwcLXprJ4APSp3XQ26xsUHTi0jcb1hoBt",oe="https://33333.cke-cs.com/easyimage/upload/",re="33333.cke-cs.com/ws",k={tokenUrl:te,uploadUrl:oe,webSocketUrl:re};i();var C="https://api.ckbox.io/token/demo";i();import{Plugin as io}from"@ckeditor/ckeditor5-core";import{Essentials as ao}from"@ckeditor/ckeditor5-essentials";import{Autoformat as so}from"@ckeditor/ckeditor5-autoformat";import{BlockQuote as mo}from"@ckeditor/ckeditor5-block-quote";import{Bold as po,Italic as go}from"@ckeditor/ckeditor5-basic-styles";import{Heading as fo}from"@ckeditor/ckeditor5-heading";import{Image as yo,ImageCaption as ko,ImageStyle as wo,ImageToolbar as vo}from"@ckeditor/ckeditor5-image";import{Indent as Io}from"@ckeditor/ckeditor5-indent";import{Link as xo}from"@ckeditor/ckeditor5-link";import{List as Ao}from"@ckeditor/ckeditor5-list";import{MediaEmbed as Lo}from"@ckeditor/ckeditor5-media-embed";import{Paragraph as _o}from"@ckeditor/ckeditor5-paragraph";import{Table as Fo,TableToolbar as Mo}from"@ckeditor/ckeditor5-table";i();function I(){let e=document.documentElement;return parseInt(window.getComputedStyle(e).getPropertyValue("--ck-snippet-viewport-top-offset"))}function w(e){return document.querySelector(`link[href*="${e}/snippet.css"][data-cke]`)?.href||""}i();import{BalloonEditor as Ho,Essentials as Wo,Autoformat as No,BlockToolbar as zo,Bold as Ko,Italic as Vo,BlockQuote as Qo,CKBox as jo,Heading as Jo,Image as Go,ImageCaption as $o,ImageStyle as Zo,ImageToolbar as Xo,ImageUpload as Yo,PictureEditing as er,Indent as tr,IndentBlock as or,Link as rr,List as ir,MediaEmbed as nr,Paragraph as ar,PasteFromOffice as lr,Table as sr,TableToolbar as dr,TextTransformation as cr,CloudServices as mr}from"ckeditor5";i();import{BalloonEditor as hr,Essentials as fr,Autoformat as br,Bold as yr,Italic as kr,BlockQuote as wr,CKBox as vr,Heading as Cr,Image as Ir,ImageCaption as Tr,ImageStyle as xr,ImageToolbar as Sr,ImageUpload as Ar,PictureEditing as Er,Indent as Lr,IndentBlock as Br,Link as _r,List as Pr,MediaEmbed as Fr,Paragraph as Mr,PasteFromOffice as Ur,Table as Dr,TableToolbar as Rr,TextTransformation as Or,CloudServices as qr}from"ckeditor5";i();import{ClassicEditor as zr,Essentials as Kr,Autoformat as Vr,Bold as Qr,Italic as jr,BlockQuote as Jr,CKBox as Gr,Heading as $r,Image as Zr,ImageCaption as Xr,ImageStyle as Yr,ImageToolbar as ei,ImageUpload as ti,PictureEditing as oi,Indent as ri,IndentBlock as ii,Link as ni,List as ai,MediaEmbed as li,Paragraph as si,PasteFromOffice as di,Table as ci,TableToolbar as mi,TextTransformation as ui,CloudServices as pi,AutoImage as gi,ImageInsert as hi,Bookmark as fi}from"ckeditor5";i();import{DecoupledEditor as wi,Essentials as vi,Alignment as Ci,FontSize as Ii,FontFamily as Ti,FontColor as xi,FontBackgroundColor as Si,Autoformat as Ai,Bold as Ei,Italic as Li,Strikethrough as Bi,Underline as _i,BlockQuote as Pi,CKBox as Fi,Heading as Mi,Image as Ui,ImageCaption as Di,ImageResize as Ri,ImageStyle as Oi,ImageToolbar as qi,ImageUpload as Hi,PictureEditing as Wi,Indent as Ni,IndentBlock as zi,Link as Ki,List as Vi,ListProperties as Qi,MediaEmbed as ji,Paragraph as Ji,PasteFromOffice as Gi,Table as $i,TableToolbar as Zi,TextTransformation as Xi,CloudServices as Yi}from"ckeditor5";i();import{InlineEditor as rn,Essentials as nn,Autoformat as an,Bold as ln,Italic as sn,BlockQuote as dn,CKBox as cn,Heading as mn,Image as un,ImageCaption as pn,ImageStyle as gn,ImageToolbar as hn,ImageUpload as fn,PictureEditing as bn,Indent as yn,IndentBlock as kn,Link as wn,List as vn,MediaEmbed as Cn,Paragraph as In,PasteFromOffice as Tn,Table as xn,TableToolbar as Sn,TextTransformation as An,CloudServices as En}from"ckeditor5";i();import{MultiRootEditor as Pn,Essentials as Fn,Autoformat as Mn,Bold as Un,Italic as Dn,BlockQuote as Rn,CKBox as On,Heading as qn,Image as Hn,ImageCaption as Wn,ImageStyle as Nn,ImageToolbar as zn,ImageUpload as Kn,PictureEditing as Vn,Indent as Qn,IndentBlock as jn,Link as Jn,List as Gn,MediaEmbed as $n,Paragraph as Zn,PasteFromOffice as Xn,Table as Yn,TableToolbar as ea,TextTransformation as ta,CloudServices as oa}from"ckeditor5";import{AIChat as vt,AIEditorIntegration as Ct,AIQuickActions as It,AIReviewMode as Tt,AITranslate as xt,CaseChange as St,Comments as At,CommentsRepository as Et,ExportPdf as Lt,ExportWord as Bt,Footnotes as _t,FormatPainter as Pt,ImportWord as Ft,LineHeight as Mt,MergeFields as Ut,MultiLevelList as Dt,PasteFromOfficeEnhanced as Rt,SlashCommand as Ot,TableOfContents as qt,Template as Ht,TrackChanges as Wt,TrackChangesData as Nt,TrackChangesPreview as zt,Users as Kt}from"ckeditor5-premium-features";i();i();import{uid as ie}from"ckeditor5";function P(){let e=["Bo","Jo","Moe","Mex","Tex","Hex","Brick","Em","Plate","Zee","DJ","CJ","AJ"],o=["King","Egli","Zwart","Principe","Siddiqui","Ehlers","Coltrane","Grimes","Cavallaro","Croce","Haddox","Weatherspoon","Gilpatrick","Funderburk","Mustard","Enterline","Redden","Hayford","Hevey","Dey","Demaio","Chenard","Whalley","Light","Kleist","Huntsman","Drovin","Duenes","Weintraub","Mcbeath","Harden","Streicher","Nadel","Philbrick","Ramm","Byrge","Broce","Olivera","Hamm","Tweedie","Hershman","Hertzler","Fielding","Dao","Constante","Berens","Finks","Corvin","Lemmons","Cuenca"],r=ie(),t=e[Math.floor(Math.random()*e.length)],n=o[Math.floor(Math.random()*o.length)];return{name:t+" "+n,id:r}}function F(e,o=P()){return`${e}?`+Object.keys(o).filter(t=>o[t]).map(t=>`user.${t}=${o[t]}`).join("&")}i();function M(e){e.plugins.has("AIErrorSink")&&e.plugins.get("AIErrorSink").on("error",(o,{error:r,component:t,code:n,type:s,severity:d,context:c})=>{typeof window.Sentry>"u"||s==="user"||s==="network"||window.Sentry.captureException(r,{tags:{component:t,errorCode:n,errorType:s},level:d==="warning"?"warning":"error",extra:c})})}i();function U(e){e.commands.get("aiQuickAction")&&e.commands.get("aiQuickAction").on("execute",(r,t)=>{t[0].type==="CHAT"&&(e.commands.get("toggleAi").value||e.execute("toggleAi"))},{priority:"high"})}i();var H=ee(q(),1);function S(e){e.on("ready",()=>{let o=e.plugins.get("AnnotationsUIs"),r=e.commands.get("toggleFullscreen"),t=document.querySelector(".editing-area-scroll-wrapper"),n=parseFloat(window.getComputedStyle(document.documentElement).getPropertyValue("--ck-demo-sidebar-wide-min-width"));if(isNaN(parseFloat(n))){console.error("--ck-demo-sidebar-wide-min-width is required by DynamicAnnotationsModeIntegration");return}let s=new Map([[document.querySelector(".editing-area-scroll-wrapper .ck.editor-content"),["margin-left","margin-right","border-left-width","border-right-width","scrollWidth"]],[document.querySelector(".editing-area-scroll-wrapper .editor-content-wrapper"),["padding-left","padding-right"]]]),d=(0,H.default)(()=>{if(!(r&&r.value))if(t.scrollWidth>t.clientWidth)u("narrowSidebar");else{let l=0;s.forEach((g,p)=>{let h=getComputedStyle(p);for(let b of g)b==="scrollWidth"?l+=p.scrollWidth:l+=parseFloat(h.getPropertyValue(b))||0}),l+n<t.clientWidth&&u("wideSidebar")}},10),c=new ResizeObserver(d);c.observe(t),c.observe(document.querySelector(".editor-content-wrapper")),r&&r.on("execute",()=>{r.value||d()}),d();let m="wideSidebar";function u(l){m!==l&&(o.switchTo(l),m=l)}})}i();function A(){let e=document.querySelectorAll(".live-snippet"),o=[];return e.forEach(r=>{let t=r.querySelector(".live-snippet__container");if(!t)return;let n=document.createElement("div");n.classList.add("live-snippet__loader"),n.innerHTML=`<svg class="spinner" viewBox="25 25 50 50">
				<circle class="path" cx="50" cy="50" r="20" fill="none" stroke-width="2" stroke-miterlimit="10"></circle>
			</svg>`,r.prepend(n),o.push({container:t,spinner:n,markDemoAsLoaded(){n.classList.add("fadeout"),t.classList.add("loaded")}})}),o}i();import{uid as se}from"ckeditor5";function E(e){let o=location.search.match(new RegExp(`${e}=([^&]+)`)),r=o?decodeURIComponent(o[1]):null;if(!r){r=se();let t=new URL(window.location.href);t.searchParams.set(e,r),window.history.replaceState({},document.title,t.toString())}return r}var Vt=E("channelId"),f=E("userId"),L={name:jt(),id:f,role:"writer"},B=class extends et{static get requires(){return[Kt,Et]}init(){let o=this.editor.plugins.get("Users"),r=this.editor.plugins.get("CommentsRepository");o.addUser(L),o.defineMe(L.id),r.adapter={addComment:()=>Promise.resolve(),updateComment:()=>Promise.resolve(),removeComment:()=>Promise.resolve(),getCommentThread:({threadId:t})=>{let n={"thread-1":{threadId:"thread-1",comments:[{commentId:"comment-1",authorId:f,content:"<p>What are some typical examples of Tier 2 cases?</p>",createdAt:new Date}]},"thread-2":{threadId:"thread-2",comments:[{commentId:"comment-1",authorId:f,content:"<p>Could we add one sentence explaining what qualifies as \u201Chigh-impact\u201D?</p>",createdAt:new Date}]},"thread-3":{threadId:"thread-3",comments:[{commentId:"comment-1",authorId:f,content:"<p>Can we add percentages for each category?</p>",createdAt:new Date}]},"thread-4":{threadId:"thread-4",comments:[{commentId:"comment-1",authorId:f,content:"<p>Can we add a short explanation here?</p>",createdAt:new Date}]}};return Promise.resolve(n[t])},addCommentThread:()=>Promise.resolve({comments:[]}),updateCommentThread:()=>Promise.resolve(),resolveCommentThread:()=>Promise.resolve({resolvedAt:new Date,resolvedBy:o.me.id}),reopenCommentThread:()=>Promise.resolve(),removeCommentThread:()=>Promise.resolve()}}},Qt=`<h1>Customer Support Metrics Report</h1>
