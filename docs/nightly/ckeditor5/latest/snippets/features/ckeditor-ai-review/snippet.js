var j=Object.create;var _=Object.defineProperty;var J=Object.getOwnPropertyDescriptor;var G=Object.getOwnPropertyNames;var $=Object.getPrototypeOf,Z=Object.prototype.hasOwnProperty;var X=(e,o,i)=>()=>{if(i)throw i[0];try{return e&&(o=e(e=0)),o}catch(t){throw i=[t],t}};var v=(e,o)=>()=>{try{return o||e((o={exports:{}}).exports,o),o.exports}catch(i){throw o=0,i}};var Y=(e,o,i,t)=>{if(o&&typeof o=="object"||typeof o=="function")for(let n of G(o))!Z.call(e,n)&&n!==i&&_(e,n,{get:()=>o[n],enumerable:!(t=J(o,n))||t.enumerable});return e};var ee=(e,o,i)=>(i=e!=null?j($(e)):{},Y(o||!e||!e.__esModule?_(i,"default",{value:e,enumerable:!0}):i,e));var r=X(()=>{});var D=v(T=>{"use strict";r();Object.defineProperty(T,Symbol.toStringTag,{value:"Module"});function ae(e,o,{signal:i,edges:t}={}){let n,s=null,c=t!=null&&t.includes("leading"),m=t==null||t.includes("trailing"),d=()=>{s!==null&&(e.apply(n,s),n=void 0,s=null)},p=()=>{m&&d(),h()},l=null,g=()=>{l!=null&&clearTimeout(l),l=setTimeout(()=>{l=null,p()},o)},u=()=>{l!==null&&(clearTimeout(l),l=null)},h=()=>{u(),n=void 0,s=null},b=()=>{d()},y=function(...V){if(i?.aborted)return;n=this,s=V;let Q=l==null;g(),c&&Q&&d()};return y.schedule=g,y.cancel=h,y.flush=b,i?.addEventListener("abort",h,{once:!0}),y}T.debounce=ae});var R=v(x=>{"use strict";r();Object.defineProperty(x,Symbol.toStringTag,{value:"Module"});var le=D();function se(e,o=0,i={}){typeof i!="object"&&(i={});let{leading:t=!1,trailing:n=!0,maxWait:s}=i,c=Array(2);t&&(c[0]="leading"),n&&(c[1]="trailing");let m,d=null,p=le.debounce(function(...u){m=e.apply(this,u),d=null},o,{edges:c}),l=function(...u){return s!=null&&(d===null&&(d=Date.now()),Date.now()-d>=s)?(m=e.apply(this,u),d=Date.now(),p.cancel(),p.schedule(),m):(p.apply(this,u),m)},g=()=>(p.flush(),m);return l.cancel=p.cancel,l.flush=g,l}x.debounce=se});var q=v((Ka,O)=>{r();O.exports=R().debounce});r();r();import{Alignment as ce,Autoformat as W,AutoImage as me,AutoLink as pe,Autosave as ue,BalloonToolbar as ge,BlockQuote as he,Bold as N,Bookmark as fe,CKBox as be,CKBoxImageEdit as ye,CloudServices as ke,Code as we,DecoupledEditor as ve,Emoji as Ce,Essentials as Ie,FindAndReplace as Te,FontBackgroundColor as xe,FontColor as Se,FontFamily as Ae,FontSize as Ee,Fullscreen as Le,GeneralHtmlSupport as Be,Heading as _e,HorizontalLine as Pe,ImageBlock as Fe,ImageCaption as Me,ImageEditing as Ue,ImageInline as De,ImageInsert as Re,ImageInsertViaUrl as Oe,ImageResize as qe,ImageStyle as He,ImageTextAlternative as We,ImageToolbar as Ne,ImageUpload as ze,ImageUtils as Ke,Indent as Ve,IndentBlock as Qe,Italic as z,Link as je,LinkImage as Je,List as Ge,ListProperties as $e,Mention as Ze,Paragraph as Xe,PasteFromOffice as Ye,PictureEditing as et,Plugin as tt,RemoveFormat as ot,SpecialCharacters as it,SpecialCharactersArrows as rt,SpecialCharactersCurrency as nt,SpecialCharactersEssentials as at,SpecialCharactersLatin as lt,SpecialCharactersMathematical as st,SpecialCharactersText as dt,Strikethrough as ct,Subscript as mt,Superscript as pt,Table as ut,TableCaption as gt,TableCellProperties as ht,TableColumnResize as ft,TableProperties as bt,TableToolbar as yt,TextTransformation as kt,TodoList as wt,Underline as vt}from"ckeditor5";r();r();var te="https://33333.cke-cs.com/token/dev/ijrDsqFix838Gh3wGO3F77FSW94BwcLXprJ4APSp3XQ26xsUHTi0jcb1hoBt",oe="https://33333.cke-cs.com/easyimage/upload/",ie="33333.cke-cs.com/ws",k={tokenUrl:te,uploadUrl:oe,webSocketUrl:ie};r();var C="https://api.ckbox.io/token/demo";r();import{Plugin as no}from"@ckeditor/ckeditor5-core";import{Essentials as lo}from"@ckeditor/ckeditor5-essentials";import{Autoformat as co}from"@ckeditor/ckeditor5-autoformat";import{BlockQuote as po}from"@ckeditor/ckeditor5-block-quote";import{Bold as go,Italic as ho}from"@ckeditor/ckeditor5-basic-styles";import{Heading as bo}from"@ckeditor/ckeditor5-heading";import{Image as ko,ImageCaption as wo,ImageStyle as vo,ImageToolbar as Co}from"@ckeditor/ckeditor5-image";import{Indent as To}from"@ckeditor/ckeditor5-indent";import{Link as So}from"@ckeditor/ckeditor5-link";import{List as Eo}from"@ckeditor/ckeditor5-list";import{MediaEmbed as Bo}from"@ckeditor/ckeditor5-media-embed";import{Paragraph as Po}from"@ckeditor/ckeditor5-paragraph";import{Table as Mo,TableToolbar as Uo}from"@ckeditor/ckeditor5-table";r();function I(){let e=document.documentElement;return parseInt(window.getComputedStyle(e).getPropertyValue("--ck-snippet-viewport-top-offset"))}function w(e){return document.querySelector(`link[href*="${e}/snippet.css"][data-cke]`)?.href||""}r();import{BalloonEditor as Wo,Essentials as No,Autoformat as zo,BlockToolbar as Ko,Bold as Vo,Italic as Qo,BlockQuote as jo,CKBox as Jo,Heading as Go,Image as $o,ImageCaption as Zo,ImageStyle as Xo,ImageToolbar as Yo,ImageUpload as ei,PictureEditing as ti,Indent as oi,IndentBlock as ii,Link as ri,List as ni,MediaEmbed as ai,Paragraph as li,PasteFromOffice as si,Table as di,TableToolbar as ci,TextTransformation as mi,CloudServices as pi}from"ckeditor5";r();import{BalloonEditor as fi,Essentials as bi,Autoformat as yi,Bold as ki,Italic as wi,BlockQuote as vi,CKBox as Ci,Heading as Ii,Image as Ti,ImageCaption as xi,ImageStyle as Si,ImageToolbar as Ai,ImageUpload as Ei,PictureEditing as Li,Indent as Bi,IndentBlock as _i,Link as Pi,List as Fi,MediaEmbed as Mi,Paragraph as Ui,PasteFromOffice as Di,Table as Ri,TableToolbar as Oi,TextTransformation as qi,CloudServices as Hi}from"ckeditor5";r();import{ClassicEditor as Ki,Essentials as Vi,Autoformat as Qi,Bold as ji,Italic as Ji,BlockQuote as Gi,CKBox as $i,Heading as Zi,Image as Xi,ImageCaption as Yi,ImageStyle as er,ImageToolbar as tr,ImageUpload as or,PictureEditing as ir,Indent as rr,IndentBlock as nr,Link as ar,List as lr,MediaEmbed as sr,Paragraph as dr,PasteFromOffice as cr,Table as mr,TableToolbar as pr,TextTransformation as ur,CloudServices as gr,AutoImage as hr,ImageInsert as fr,Bookmark as br}from"ckeditor5";r();import{DecoupledEditor as vr,Essentials as Cr,Alignment as Ir,FontSize as Tr,FontFamily as xr,FontColor as Sr,FontBackgroundColor as Ar,Autoformat as Er,Bold as Lr,Italic as Br,Strikethrough as _r,Underline as Pr,BlockQuote as Fr,CKBox as Mr,Heading as Ur,Image as Dr,ImageCaption as Rr,ImageResize as Or,ImageStyle as qr,ImageToolbar as Hr,ImageUpload as Wr,PictureEditing as Nr,Indent as zr,IndentBlock as Kr,Link as Vr,List as Qr,ListProperties as jr,MediaEmbed as Jr,Paragraph as Gr,PasteFromOffice as $r,Table as Zr,TableToolbar as Xr,TextTransformation as Yr,CloudServices as en}from"ckeditor5";r();import{InlineEditor as nn,Essentials as an,Autoformat as ln,Bold as sn,Italic as dn,BlockQuote as cn,CKBox as mn,Heading as pn,Image as un,ImageCaption as gn,ImageStyle as hn,ImageToolbar as fn,ImageUpload as bn,PictureEditing as yn,Indent as kn,IndentBlock as wn,Link as vn,List as Cn,MediaEmbed as In,Paragraph as Tn,PasteFromOffice as xn,Table as Sn,TableToolbar as An,TextTransformation as En,CloudServices as Ln}from"ckeditor5";r();import{MultiRootEditor as Fn,Essentials as Mn,Autoformat as Un,Bold as Dn,Italic as Rn,BlockQuote as On,CKBox as qn,Heading as Hn,Image as Wn,ImageCaption as Nn,ImageStyle as zn,ImageToolbar as Kn,ImageUpload as Vn,PictureEditing as Qn,Indent as jn,IndentBlock as Jn,Link as Gn,List as $n,MediaEmbed as Zn,Paragraph as Xn,PasteFromOffice as Yn,Table as ea,TableToolbar as ta,TextTransformation as oa,CloudServices as ia}from"ckeditor5";import{AIChat as Ct,AIEditorIntegration as It,AIQuickActions as Tt,AIReviewMode as xt,AITranslate as St,CaseChange as At,Comments as Et,CommentsRepository as Lt,ExportPdf as Bt,ExportWord as _t,Footnotes as Pt,FormatPainter as Ft,ImportWord as Mt,LineHeight as Ut,MergeFields as Dt,MultiLevelList as Rt,PasteFromOfficeEnhanced as Ot,SlashCommand as qt,TableOfContents as Ht,Template as Wt,TrackChanges as Nt,TrackChangesData as zt,TrackChangesPreview as Kt,Users as Vt}from"ckeditor5-premium-features";r();r();import{uid as re}from"ckeditor5";function P(){let e=["Bo","Jo","Moe","Mex","Tex","Hex","Brick","Em","Plate","Zee","DJ","CJ","AJ"],o=["King","Egli","Zwart","Principe","Siddiqui","Ehlers","Coltrane","Grimes","Cavallaro","Croce","Haddox","Weatherspoon","Gilpatrick","Funderburk","Mustard","Enterline","Redden","Hayford","Hevey","Dey","Demaio","Chenard","Whalley","Light","Kleist","Huntsman","Drovin","Duenes","Weintraub","Mcbeath","Harden","Streicher","Nadel","Philbrick","Ramm","Byrge","Broce","Olivera","Hamm","Tweedie","Hershman","Hertzler","Fielding","Dao","Constante","Berens","Finks","Corvin","Lemmons","Cuenca"],i=re(),t=e[Math.floor(Math.random()*e.length)],n=o[Math.floor(Math.random()*o.length)];return{name:t+" "+n,id:i}}function F(e,o=P()){return`${e}?`+Object.keys(o).filter(t=>o[t]).map(t=>`user.${t}=${o[t]}`).join("&")}r();import{AICoreError as ne}from"ckeditor5-premium-features";function M(e){e.plugins.has("AIErrorSink")&&e.plugins.get("AIErrorSink").on("error",(o,{error:i,component:t,context:n})=>{typeof window.Sentry>"u"||i instanceof ne&&(i.type==="user"||i.type==="network")||window.Sentry.captureException(i,{tags:{component:t},extra:n})})}r();function U(e){e.commands.get("aiQuickAction")&&e.commands.get("aiQuickAction").on("execute",(i,t)=>{t[0].type==="CHAT"&&(e.commands.get("toggleAi").value||e.execute("toggleAi"))},{priority:"high"})}r();var H=ee(q(),1);function S(e){e.on("ready",()=>{let o=e.plugins.get("AnnotationsUIs"),i=e.commands.get("toggleFullscreen"),t=document.querySelector(".editing-area-scroll-wrapper"),n=parseFloat(window.getComputedStyle(document.documentElement).getPropertyValue("--ck-demo-sidebar-wide-min-width"));if(isNaN(parseFloat(n))){console.error("--ck-demo-sidebar-wide-min-width is required by DynamicAnnotationsModeIntegration");return}let s=new Map([[document.querySelector(".editing-area-scroll-wrapper .ck.editor-content"),["margin-left","margin-right","border-left-width","border-right-width","scrollWidth"]],[document.querySelector(".editing-area-scroll-wrapper .editor-content-wrapper"),["padding-left","padding-right"]]]),c=(0,H.default)(()=>{if(!(i&&i.value))if(t.scrollWidth>t.clientWidth)p("narrowSidebar");else{let l=0;s.forEach((g,u)=>{let h=getComputedStyle(u);for(let b of g)b==="scrollWidth"?l+=u.scrollWidth:l+=parseFloat(h.getPropertyValue(b))||0}),l+n<t.clientWidth&&p("wideSidebar")}},10),m=new ResizeObserver(c);m.observe(t),m.observe(document.querySelector(".editor-content-wrapper")),i&&i.on("execute",()=>{i.value||c()}),c();let d="wideSidebar";function p(l){d!==l&&(o.switchTo(l),d=l)}})}r();function A(){let e=document.querySelectorAll(".live-snippet"),o=[];return e.forEach(i=>{let t=i.querySelector(".live-snippet__container");if(!t)return;let n=document.createElement("div");n.classList.add("live-snippet__loader"),n.innerHTML=`<svg class="spinner" viewBox="25 25 50 50">
				<circle class="path" cx="50" cy="50" r="20" fill="none" stroke-width="2" stroke-miterlimit="10"></circle>
			</svg>`,i.prepend(n),o.push({container:t,spinner:n,markDemoAsLoaded(){n.classList.add("fadeout"),t.classList.add("loaded")}})}),o}r();import{uid as de}from"ckeditor5";function E(e){let o=location.search.match(new RegExp(`${e}=([^&]+)`)),i=o?decodeURIComponent(o[1]):null;if(!i){i=de();let t=new URL(window.location.href);t.searchParams.set(e,i),window.history.replaceState({},document.title,t.toString())}return i}var Qt=E("channelId"),f=E("userId"),L={name:Jt(),id:f,role:"writer"},B=class extends tt{static get requires(){return[Vt,Lt]}init(){let o=this.editor.plugins.get("Users"),i=this.editor.plugins.get("CommentsRepository");o.addUser(L),o.defineMe(L.id),i.adapter={addComment:()=>Promise.resolve(),updateComment:()=>Promise.resolve(),removeComment:()=>Promise.resolve(),getCommentThread:({threadId:t})=>{let n={"thread-1":{threadId:"thread-1",comments:[{commentId:"comment-1",authorId:f,content:"<p>What are some typical examples of Tier 2 cases?</p>",createdAt:new Date}]},"thread-2":{threadId:"thread-2",comments:[{commentId:"comment-1",authorId:f,content:"<p>Could we add one sentence explaining what qualifies as \u201Chigh-impact\u201D?</p>",createdAt:new Date}]},"thread-3":{threadId:"thread-3",comments:[{commentId:"comment-1",authorId:f,content:"<p>Can we add percentages for each category?</p>",createdAt:new Date}]},"thread-4":{threadId:"thread-4",comments:[{commentId:"comment-1",authorId:f,content:"<p>Can we add a short explanation here?</p>",createdAt:new Date}]}};return Promise.resolve(n[t])},addCommentThread:()=>Promise.resolve({comments:[]}),updateCommentThread:()=>Promise.resolve(),resolveCommentThread:()=>Promise.resolve({resolvedAt:new Date,resolvedBy:o.me.id}),reopenCommentThread:()=>Promise.resolve(),removeCommentThread:()=>Promise.resolve()}}},jt=`<h1>Customer Support Metrics Report</h1>
