var j=Object.create;var P=Object.defineProperty;var J=Object.getOwnPropertyDescriptor;var G=Object.getOwnPropertyNames;var $=Object.getPrototypeOf,Z=Object.prototype.hasOwnProperty;var X=(e,t)=>()=>(e&&(t=e(e=0)),t);var C=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports);var Y=(e,t,i,r)=>{if(t&&typeof t=="object"||typeof t=="function")for(let n of G(t))!Z.call(e,n)&&n!==i&&P(e,n,{get:()=>t[n],enumerable:!(r=J(t,n))||r.enumerable});return e};var ee=(e,t,i)=>(i=e!=null?j($(e)):{},Y(t||!e||!e.__esModule?P(i,"default",{value:e,enumerable:!0}):i,e));var o=X(()=>{});var D=C(T=>{"use strict";o();Object.defineProperty(T,Symbol.toStringTag,{value:"Module"});function ne(e,t,{signal:i,edges:r}={}){let n,l=null,c=r!=null&&r.includes("leading"),m=r==null||r.includes("trailing"),d=()=>{l!==null&&(e.apply(n,l),n=void 0,l=null)},u=()=>{m&&d(),h()},s=null,g=()=>{s!=null&&clearTimeout(s),s=setTimeout(()=>{s=null,u()},t)},p=()=>{s!==null&&(clearTimeout(s),s=null)},h=()=>{p(),n=void 0,l=null},b=()=>{d()},y=function(...V){if(i?.aborted)return;n=this,l=V;let Q=s==null;g(),c&&Q&&d()};return y.schedule=g,y.cancel=h,y.flush=b,i?.addEventListener("abort",h,{once:!0}),y}T.debounce=ne});var U=C(x=>{"use strict";o();Object.defineProperty(x,Symbol.toStringTag,{value:"Module"});var ae=D();function se(e,t=0,i={}){typeof i!="object"&&(i={});let{leading:r=!1,trailing:n=!0,maxWait:l}=i,c=Array(2);r&&(c[0]="leading"),n&&(c[1]="trailing");let m,d=null,u=ae.debounce(function(...p){m=e.apply(this,p),d=null},t,{edges:c}),s=function(...p){return l!=null&&(d===null&&(d=Date.now()),Date.now()-d>=l)?(m=e.apply(this,p),d=Date.now(),u.cancel(),u.schedule(),m):(u.apply(this,p),m)},g=()=>(u.flush(),m);return s.cancel=u.cancel,s.flush=g,s}x.debounce=se});var O=C((za,R)=>{o();R.exports=U().debounce});o();import{WideSidebar as jt,AIChatShortcuts as Jt}from"ckeditor5-premium-features";o();import{Alignment as de,Autoformat as H,AutoImage as ce,AutoLink as me,Autosave as ue,BalloonToolbar as pe,BlockQuote as ge,Bold as z,Bookmark as he,CKBox as fe,CKBoxImageEdit as be,CloudServices as ye,Code as we,DecoupledEditor as ke,Emoji as Ce,Essentials as ve,FindAndReplace as Ie,FontBackgroundColor as Te,FontColor as xe,FontFamily as Se,FontSize as Ee,Fullscreen as Ae,Heading as Be,HorizontalLine as Le,ImageBlock as Pe,ImageCaption as _e,ImageEditing as Me,ImageInline as Fe,ImageInsert as De,ImageInsertViaUrl as Ue,ImageResize as Re,ImageStyle as Oe,ImageTextAlternative as qe,ImageToolbar as He,ImageUpload as ze,ImageUtils as We,Indent as Ne,IndentBlock as Ke,Italic as W,Link as Ve,LinkImage as Qe,List as je,ListProperties as Je,Mention as Ge,Paragraph as $e,PasteFromOffice as Ze,PictureEditing as Xe,Plugin as Ye,RemoveFormat as et,SpecialCharacters as tt,SpecialCharactersArrows as ot,SpecialCharactersCurrency as rt,SpecialCharactersEssentials as it,SpecialCharactersLatin as nt,SpecialCharactersMathematical as at,SpecialCharactersText as st,Strikethrough as lt,Subscript as dt,Superscript as ct,Table as mt,TableCaption as ut,TableCellProperties as pt,TableColumnResize as gt,TableProperties as ht,TableToolbar as ft,TextTransformation as bt,TodoList as yt,Underline as wt}from"ckeditor5";o();o();var te="https://33333.cke-cs.com/token/dev/ijrDsqFix838Gh3wGO3F77FSW94BwcLXprJ4APSp3XQ26xsUHTi0jcb1hoBt",oe="https://33333.cke-cs.com/easyimage/upload/",re="33333.cke-cs.com/ws",w={tokenUrl:te,uploadUrl:oe,webSocketUrl:re};o();var v="https://api.ckbox.io/token/demo";o();import{Plugin as no}from"@ckeditor/ckeditor5-core";import{Essentials as so}from"@ckeditor/ckeditor5-essentials";import{Autoformat as co}from"@ckeditor/ckeditor5-autoformat";import{BlockQuote as uo}from"@ckeditor/ckeditor5-block-quote";import{Bold as go,Italic as ho}from"@ckeditor/ckeditor5-basic-styles";import{Heading as bo}from"@ckeditor/ckeditor5-heading";import{Image as wo,ImageCaption as ko,ImageStyle as Co,ImageToolbar as vo}from"@ckeditor/ckeditor5-image";import{Indent as To}from"@ckeditor/ckeditor5-indent";import{Link as So}from"@ckeditor/ckeditor5-link";import{List as Ao}from"@ckeditor/ckeditor5-list";import{MediaEmbed as Lo}from"@ckeditor/ckeditor5-media-embed";import{Paragraph as _o}from"@ckeditor/ckeditor5-paragraph";import{Table as Fo,TableToolbar as Do}from"@ckeditor/ckeditor5-table";o();function I(){let e=document.documentElement;return parseInt(window.getComputedStyle(e).getPropertyValue("--ck-snippet-viewport-top-offset"))}function k(e){return document.querySelector(`link[href*="${e}/snippet.css"][data-cke]`)?.href||""}o();import{BalloonEditor as zo,Essentials as Wo,Autoformat as No,BlockToolbar as Ko,Bold as Vo,Italic as Qo,BlockQuote as jo,CKBox as Jo,Heading as Go,Image as $o,ImageCaption as Zo,ImageStyle as Xo,ImageToolbar as Yo,ImageUpload as er,PictureEditing as tr,Indent as or,IndentBlock as rr,Link as ir,List as nr,MediaEmbed as ar,Paragraph as sr,PasteFromOffice as lr,Table as dr,TableToolbar as cr,TextTransformation as mr,CloudServices as ur}from"ckeditor5";o();import{BalloonEditor as fr,Essentials as br,Autoformat as yr,Bold as wr,Italic as kr,BlockQuote as Cr,CKBox as vr,Heading as Ir,Image as Tr,ImageCaption as xr,ImageStyle as Sr,ImageToolbar as Er,ImageUpload as Ar,PictureEditing as Br,Indent as Lr,IndentBlock as Pr,Link as _r,List as Mr,MediaEmbed as Fr,Paragraph as Dr,PasteFromOffice as Ur,Table as Rr,TableToolbar as Or,TextTransformation as qr,CloudServices as Hr}from"ckeditor5";o();import{ClassicEditor as Kr,Essentials as Vr,Autoformat as Qr,Bold as jr,Italic as Jr,BlockQuote as Gr,CKBox as $r,Heading as Zr,Image as Xr,ImageCaption as Yr,ImageStyle as ei,ImageToolbar as ti,ImageUpload as oi,PictureEditing as ri,Indent as ii,IndentBlock as ni,Link as ai,List as si,MediaEmbed as li,Paragraph as di,PasteFromOffice as ci,Table as mi,TableToolbar as ui,TextTransformation as pi,CloudServices as gi,AutoImage as hi,ImageInsert as fi,Bookmark as bi}from"ckeditor5";o();import{DecoupledEditor as Ci,Essentials as vi,Alignment as Ii,FontSize as Ti,FontFamily as xi,FontColor as Si,FontBackgroundColor as Ei,Autoformat as Ai,Bold as Bi,Italic as Li,Strikethrough as Pi,Underline as _i,BlockQuote as Mi,CKBox as Fi,Heading as Di,Image as Ui,ImageCaption as Ri,ImageResize as Oi,ImageStyle as qi,ImageToolbar as Hi,ImageUpload as zi,PictureEditing as Wi,Indent as Ni,IndentBlock as Ki,Link as Vi,List as Qi,ListProperties as ji,MediaEmbed as Ji,Paragraph as Gi,PasteFromOffice as $i,Table as Zi,TableToolbar as Xi,TextTransformation as Yi,CloudServices as en}from"ckeditor5";o();import{InlineEditor as nn,Essentials as an,Autoformat as sn,Bold as ln,Italic as dn,BlockQuote as cn,CKBox as mn,Heading as un,Image as pn,ImageCaption as gn,ImageStyle as hn,ImageToolbar as fn,ImageUpload as bn,PictureEditing as yn,Indent as wn,IndentBlock as kn,Link as Cn,List as vn,MediaEmbed as In,Paragraph as Tn,PasteFromOffice as xn,Table as Sn,TableToolbar as En,TextTransformation as An,CloudServices as Bn}from"ckeditor5";o();import{MultiRootEditor as Mn,Essentials as Fn,Autoformat as Dn,Bold as Un,Italic as Rn,BlockQuote as On,CKBox as qn,Heading as Hn,Image as zn,ImageCaption as Wn,ImageStyle as Nn,ImageToolbar as Kn,ImageUpload as Vn,PictureEditing as Qn,Indent as jn,IndentBlock as Jn,Link as Gn,List as $n,MediaEmbed as Zn,Paragraph as Xn,PasteFromOffice as Yn,Table as ea,TableToolbar as ta,TextTransformation as oa,CloudServices as ra}from"ckeditor5";import{AIChat as kt,AIEditorIntegration as Ct,AIQuickActions as vt,AIReviewMode as It,AITranslate as Tt,CaseChange as xt,Comments as St,CommentsRepository as Et,ExportPdf as At,ExportWord as Bt,Footnotes as Lt,FormatPainter as Pt,ImportWord as _t,LineHeight as Mt,MergeFields as Ft,MultiLevelList as Dt,PasteFromOfficeEnhanced as Ut,SlashCommand as Rt,TableOfContents as Ot,Template as qt,TrackChanges as Ht,TrackChangesData as zt,TrackChangesPreview as Wt,Users as Nt}from"ckeditor5-premium-features";o();o();import{uid as ie}from"ckeditor5";function _(){let e=["Bo","Jo","Moe","Mex","Tex","Hex","Brick","Em","Plate","Zee","DJ","CJ","AJ"],t=["King","Egli","Zwart","Principe","Siddiqui","Ehlers","Coltrane","Grimes","Cavallaro","Croce","Haddox","Weatherspoon","Gilpatrick","Funderburk","Mustard","Enterline","Redden","Hayford","Hevey","Dey","Demaio","Chenard","Whalley","Light","Kleist","Huntsman","Drovin","Duenes","Weintraub","Mcbeath","Harden","Streicher","Nadel","Philbrick","Ramm","Byrge","Broce","Olivera","Hamm","Tweedie","Hershman","Hertzler","Fielding","Dao","Constante","Berens","Finks","Corvin","Lemmons","Cuenca"],i=ie(),r=e[Math.floor(Math.random()*e.length)],n=t[Math.floor(Math.random()*t.length)];return{name:r+" "+n,id:i}}function M(e,t=_()){return`${e}?`+Object.keys(t).filter(r=>t[r]).map(r=>`user.${r}=${t[r]}`).join("&")}o();function F(e){e.commands.get("aiQuickAction")&&e.commands.get("aiQuickAction").on("execute",(i,r)=>{r[0].type==="CHAT"&&(e.commands.get("toggleAi").value||e.execute("toggleAi"))},{priority:"high"})}o();var q=ee(O(),1);function S(e){e.on("ready",()=>{let t=e.plugins.get("AnnotationsUIs"),i=e.commands.get("toggleFullscreen"),r=document.querySelector(".editing-area-scroll-wrapper"),n=parseFloat(window.getComputedStyle(document.documentElement).getPropertyValue("--ck-demo-sidebar-wide-min-width"));if(isNaN(parseFloat(n))){console.error("--ck-demo-sidebar-wide-min-width is required by DynamicAnnotationsModeIntegration");return}let l=new Map([[document.querySelector(".editing-area-scroll-wrapper .ck.editor-content"),["margin-left","margin-right","border-left-width","border-right-width","scrollWidth"]],[document.querySelector(".editing-area-scroll-wrapper .editor-content-wrapper"),["padding-left","padding-right"]]]),c=(0,q.default)(()=>{if(!(i&&i.value))if(r.scrollWidth>r.clientWidth)u("narrowSidebar");else{let s=0;l.forEach((g,p)=>{let h=getComputedStyle(p);for(let b of g)b==="scrollWidth"?s+=p.scrollWidth:s+=parseFloat(h.getPropertyValue(b))||0}),s+n<r.clientWidth&&u("wideSidebar")}},10),m=new ResizeObserver(c);m.observe(r),m.observe(document.querySelector(".editor-content-wrapper")),i&&i.on("execute",()=>{i.value||c()}),c();let d="wideSidebar";function u(s){d!==s&&(t.switchTo(s),d=s)}})}o();function E(){let e=document.querySelectorAll(".live-snippet"),t=[];return e.forEach(i=>{let r=i.querySelector(".live-snippet__container");if(!r)return;let n=document.createElement("div");n.classList.add("live-snippet__loader"),n.innerHTML=`<svg class="spinner" viewBox="25 25 50 50">
				<circle class="path" cx="50" cy="50" r="20" fill="none" stroke-width="2" stroke-miterlimit="10"></circle>
			</svg>`,i.prepend(n),t.push({container:r,spinner:n,markDemoAsLoaded(){n.classList.add("fadeout"),r.classList.add("loaded")}})}),t}o();import{uid as le}from"ckeditor5";function A(e){let t=location.search.match(new RegExp(`${e}=([^&]+)`)),i=t?decodeURIComponent(t[1]):null;if(!i){i=le();let r=new URL(window.location.href);r.searchParams.set(e,i),window.history.replaceState({},document.title,r.toString())}return i}var Kt=A("channelId"),f=A("userId"),B={name:Qt(),id:f,role:"writer"},L=class extends Ye{static get requires(){return[Nt,Et]}init(){let t=this.editor.plugins.get("Users"),i=this.editor.plugins.get("CommentsRepository");t.addUser(B),t.defineMe(B.id),i.adapter={addComment:()=>Promise.resolve(),updateComment:()=>Promise.resolve(),removeComment:()=>Promise.resolve(),getCommentThread:({threadId:r})=>{let n={"thread-1":{threadId:"thread-1",comments:[{commentId:"comment-1",authorId:f,content:"<p>What are some typical examples of Tier 2 cases?</p>",createdAt:new Date}]},"thread-2":{threadId:"thread-2",comments:[{commentId:"comment-1",authorId:f,content:"<p>Could we add one sentence explaining what qualifies as \u201Chigh-impact\u201D?</p>",createdAt:new Date}]},"thread-3":{threadId:"thread-3",comments:[{commentId:"comment-1",authorId:f,content:"<p>Can we add percentages for each category?</p>",createdAt:new Date}]},"thread-4":{threadId:"thread-4",comments:[{commentId:"comment-1",authorId:f,content:"<p>Can we add a short explanation here?</p>",createdAt:new Date}]}};return Promise.resolve(n[r])},addCommentThread:()=>Promise.resolve({comments:[]}),updateCommentThread:()=>Promise.resolve(),resolveCommentThread:()=>Promise.resolve({resolvedAt:new Date,resolvedBy:t.me.id}),reopenCommentThread:()=>Promise.resolve(),removeCommentThread:()=>Promise.resolve()}}},Vt=`<h1>Customer Support Metrics Report</h1>
