import{Alignment as N,Autoformat as F,AutoImage as V,AutoLink as j,Autosave as Q,BalloonToolbar as G,BlockQuote as $,Bold as _,Bookmark as J,CKBox as Z,CKBoxImageEdit as X,CloudServices as Y,Code as ee,DecoupledEditor as te,Emoji as oe,Essentials as re,FindAndReplace as ie,FontBackgroundColor as ae,FontColor as ne,FontFamily as se,FontSize as le,Fullscreen as me,Heading as pe,HorizontalLine as de,ImageBlock as ce,ImageCaption as fe,ImageEditing as ue,ImageInline as ge,ImageInsert as he,ImageInsertViaUrl as xe,ImageResize as be,ImageStyle as ye,ImageTextAlternative as ke,ImageToolbar as Ie,ImageUpload as we,ImageUtils as Ce,Indent as ve,IndentBlock as Te,Italic as M,Link as Se,LinkImage as Ae,List as Ee,ListProperties as Be,Mention as Le,Paragraph as Pe,PasteFromOffice as Fe,PictureEditing as _e,Plugin as Me,RemoveFormat as Oe,SpecialCharacters as De,SpecialCharactersArrows as Re,SpecialCharactersCurrency as Ue,SpecialCharactersEssentials as We,SpecialCharactersLatin as qe,SpecialCharactersMathematical as Ke,SpecialCharactersText as ze,Strikethrough as He,Subscript as Ne,Superscript as Ve,Table as je,TableCaption as Qe,TableCellProperties as Ge,TableColumnResize as $e,TableProperties as Je,TableToolbar as Ze,TextTransformation as Xe,TodoList as Ye,Underline as et,uid as tt}from"ckeditor5";var q="https://33333.cke-cs.com/token/dev/ijrDsqFix838Gh3wGO3F77FSW94BwcLXprJ4APSp3XQ26xsUHTi0jcb1hoBt",K="https://33333.cke-cs.com/easyimage/upload/",z="33333.cke-cs.com/ws",b={tokenUrl:q,uploadUrl:K,webSocketUrl:z};var k="https://api.ckbox.io/token/demo";import{Plugin as Mt}from"@ckeditor/ckeditor5-core";import{Essentials as Dt}from"@ckeditor/ckeditor5-essentials";import{Autoformat as Ut}from"@ckeditor/ckeditor5-autoformat";import{BlockQuote as qt}from"@ckeditor/ckeditor5-block-quote";import{Bold as zt,Italic as Ht}from"@ckeditor/ckeditor5-basic-styles";import{Heading as Vt}from"@ckeditor/ckeditor5-heading";import{Image as Qt,ImageCaption as Gt,ImageStyle as $t,ImageToolbar as Jt}from"@ckeditor/ckeditor5-image";import{Indent as Xt}from"@ckeditor/ckeditor5-indent";import{Link as eo}from"@ckeditor/ckeditor5-link";import{List as oo}from"@ckeditor/ckeditor5-list";import{MediaEmbed as io}from"@ckeditor/ckeditor5-media-embed";import{Paragraph as no}from"@ckeditor/ckeditor5-paragraph";import{Table as lo,TableToolbar as mo}from"@ckeditor/ckeditor5-table";function I({id:t,target:o,text:r,editor:e,tippyOptions:i}){if(!o){console.warn("[attachTourBalloon] The target DOM node for the feature tour balloon does not exist.",{text:r});return}if(!o.offsetParent){console.warn("[attachTourBalloon] The target DOM node is invisible and the balloon could not be attached.",{target:o,text:r});return}let s=window.umberto.Tooltip.create({id:t,text:r,trigger:o,mode:"click",variant:"dark",icon:"bulb",disableOnMobile:!1,showCloseButton:!0,showAfterMount:!0,hideOnOutsideClick:!1,destroyOnHide:!0,...i?.placement&&{position:i.placement}});for(let l of e.editing.view.document.roots)l.once("change:isFocused",(d,m,p)=>{p&&s.destroy()});return s}function w(){let t=document.documentElement;return parseInt(window.getComputedStyle(t).getPropertyValue("--ck-snippet-viewport-top-offset"))}function y(t){return document.querySelector(`link[href*="${t}/snippet.css"][data-cke]`)?.href||""}import{BalloonEditor as ho,Essentials as xo,CKFinderUploadAdapter as bo,Autoformat as yo,BlockToolbar as ko,Bold as Io,Italic as wo,BlockQuote as Co,CKBox as vo,CKFinder as To,EasyImage as So,Heading as Ao,Image as Eo,ImageCaption as Bo,ImageStyle as Lo,ImageToolbar as Po,ImageUpload as Fo,PictureEditing as _o,Indent as Mo,Link as Oo,List as Do,MediaEmbed as Ro,Paragraph as Uo,PasteFromOffice as Wo,Table as qo,TableToolbar as Ko,TextTransformation as zo,CloudServices as Ho}from"ckeditor5";import{BalloonEditor as Qo,Essentials as Go,CKFinderUploadAdapter as $o,Autoformat as Jo,Bold as Zo,Italic as Xo,BlockQuote as Yo,CKBox as er,CKFinder as tr,EasyImage as or,Heading as rr,Image as ir,ImageCaption as ar,ImageStyle as nr,ImageToolbar as sr,ImageUpload as lr,PictureEditing as mr,Indent as pr,Link as dr,List as cr,MediaEmbed as fr,Paragraph as ur,PasteFromOffice as gr,Table as hr,TableToolbar as xr,TextTransformation as br,CloudServices as yr}from"ckeditor5";import{ClassicEditor as Cr,Essentials as vr,Autoformat as Tr,Bold as Sr,Italic as Ar,BlockQuote as Er,CKBox as Br,EasyImage as Lr,Heading as Pr,Image as Fr,ImageCaption as _r,ImageStyle as Mr,ImageToolbar as Or,ImageUpload as Dr,PictureEditing as Rr,Indent as Ur,Link as Wr,List as qr,MediaEmbed as Kr,Paragraph as zr,PasteFromOffice as Hr,Table as Nr,TableToolbar as Vr,TextTransformation as jr,CloudServices as Qr,AutoImage as Gr,ImageInsert as $r,Bookmark as Jr}from"ckeditor5";import{DecoupledEditor as ei,Essentials as ti,Alignment as oi,FontSize as ri,FontFamily as ii,FontColor as ai,FontBackgroundColor as ni,Autoformat as si,Bold as li,Italic as mi,Strikethrough as pi,Underline as di,BlockQuote as ci,CKBox as fi,EasyImage as ui,Heading as gi,Image as hi,ImageCaption as xi,ImageResize as bi,ImageStyle as yi,ImageToolbar as ki,ImageUpload as Ii,PictureEditing as wi,Indent as Ci,IndentBlock as vi,Link as Ti,List as Si,ListProperties as Ai,MediaEmbed as Ei,Paragraph as Bi,PasteFromOffice as Li,Table as Pi,TableToolbar as Fi,TextTransformation as _i,CloudServices as Mi}from"ckeditor5";import{InlineEditor as Ui,Essentials as Wi,CKFinderUploadAdapter as qi,Autoformat as Ki,Bold as zi,Italic as Hi,BlockQuote as Ni,CKBox as Vi,CKFinder as ji,EasyImage as Qi,Heading as Gi,Image as $i,ImageCaption as Ji,ImageStyle as Zi,ImageToolbar as Xi,ImageUpload as Yi,PictureEditing as ea,Indent as ta,Link as oa,List as ra,MediaEmbed as ia,Paragraph as aa,PasteFromOffice as na,Table as sa,TableToolbar as la,TextTransformation as ma,CloudServices as pa}from"ckeditor5";import{MultiRootEditor as ua,Essentials as ga,CKFinderUploadAdapter as ha,Autoformat as xa,Bold as ba,Italic as ya,BlockQuote as ka,CKBox as Ia,CKFinder as wa,EasyImage as Ca,Heading as va,Image as Ta,ImageCaption as Sa,ImageStyle as Aa,ImageToolbar as Ea,ImageUpload as Ba,PictureEditing as La,Indent as Pa,Link as Fa,List as _a,MediaEmbed as Ma,Paragraph as Oa,PasteFromOffice as Da,Table as Ra,TableToolbar as Ua,TextTransformation as Wa,CloudServices as qa}from"ckeditor5";import{AIChat as ot,AIEditorIntegration as rt,AIQuickActions as it,AIReviewMode as at,AITranslate as nt,CaseChange as st,Comments as lt,ExportPdf as mt,ExportWord as pt,Footnotes as dt,FormatPainter as ct,ImportWord as ft,LineHeight as ut,MergeFields as gt,MultiLevelList as ht,PasteFromOfficeEnhanced as xt,SlashCommand as bt,TableOfContents as yt,Template as kt,TrackChanges as It,TrackChangesData as wt,TrackChangesPreview as Ct}from"ckeditor5-premium-features";import{uid as H}from"ckeditor5";function E(){let t=["Bo","Jo","Moe","Mex","Tex","Hex","Brick","Em","Plate","Zee","DJ","CJ","AJ"],o=["King","Egli","Zwart","Principe","Siddiqui","Ehlers","Coltrane","Grimes","Cavallaro","Croce","Haddox","Weatherspoon","Gilpatrick","Funderburk","Mustard","Enterline","Redden","Hayford","Hevey","Dey","Demaio","Chenard","Whalley","Light","Kleist","Huntsman","Drovin","Duenes","Weintraub","Mcbeath","Harden","Streicher","Nadel","Philbrick","Ramm","Byrge","Broce","Olivera","Hamm","Tweedie","Hershman","Hertzler","Fielding","Dao","Constante","Berens","Finks","Corvin","Lemmons","Cuenca"],r=H(),e=t[Math.floor(Math.random()*t.length)],i=o[Math.floor(Math.random()*o.length)];return{name:e+" "+i,id:r}}function B(t,o=E()){return`${t}?`+Object.keys(o).filter(e=>o[e]).map(e=>`user.${e}=${o[e]}`).join("&")}function L(t){t.commands.get("aiQuickAction")&&t.commands.get("aiQuickAction").on("execute",(r,e)=>{e[0].type==="CHAT"&&(t.commands.get("toggleAi").value||t.execute("toggleAi"))},{priority:"high"})}function P(t,o,{signal:r,edges:e}={}){let i,s=null,l=e!=null&&e.includes("leading"),d=e==null||e.includes("trailing"),m=()=>{s!==null&&(t.apply(i,s),i=void 0,s=null)},p=()=>{d&&m(),u()},n=null,f=()=>{n!=null&&clearTimeout(n),n=setTimeout(()=>{n=null,p()},o)},c=()=>{n!==null&&(clearTimeout(n),n=null)},u=()=>{c(),i=void 0,s=null},h=()=>{c(),m()},x=function(...U){if(r?.aborted)return;i=this,s=U;let W=n==null;f(),l&&W&&m()};return x.schedule=f,x.cancel=u,x.flush=h,r?.addEventListener("abort",u,{once:!0}),x}function C(t,o=0,r={}){typeof r!="object"&&(r={});let{leading:e=!1,trailing:i=!0,maxWait:s}=r,l=Array(2);e&&(l[0]="leading"),i&&(l[1]="trailing");let d,m=null,p=P(function(...c){d=t.apply(this,c),m=null},o,{edges:l}),n=function(...c){return s!=null&&(m===null&&(m=Date.now()),Date.now()-m>=s)?(d=t.apply(this,c),m=Date.now(),p.cancel(),p.schedule(),d):(p.apply(this,c),d)},f=()=>(p.flush(),d);return n.cancel=p.cancel,n.flush=f,n}function v(t){t.on("ready",()=>{let o=t.plugins.get("AnnotationsUIs"),r=t.commands.get("toggleFullscreen"),e=document.querySelector(".editing-area-scroll-wrapper"),i=parseFloat(window.getComputedStyle(document.documentElement).getPropertyValue("--ck-demo-sidebar-wide-min-width"));if(isNaN(parseFloat(i))){console.error("--ck-demo-sidebar-wide-min-width is required by DynamicAnnotationsModeIntegration");return}let s=new Map([[document.querySelector(".editing-area-scroll-wrapper .ck.editor-content"),["margin-left","margin-right","border-left-width","border-right-width","scrollWidth"]],[document.querySelector(".editing-area-scroll-wrapper .editor-content-wrapper"),["padding-left","padding-right"]]]),l=C(()=>{if(!(r&&r.value))if(e.scrollWidth>e.clientWidth)p("narrowSidebar");else{let n=0;s.forEach((f,c)=>{let u=getComputedStyle(c);for(let h of f)h==="scrollWidth"?n+=c.scrollWidth:n+=parseFloat(u.getPropertyValue(h))||0}),n+i<e.clientWidth&&p("wideSidebar")}},10),d=new ResizeObserver(l);d.observe(e),d.observe(document.querySelector(".editor-content-wrapper")),r&&r.on("execute",()=>{r.value||l()}),l();let m="wideSidebar";function p(n){m!==n&&(o.switchTo(n),m=n)}})}function T(){let t=document.querySelectorAll(".live-snippet"),o=[];return t.forEach(r=>{let e=r.querySelector(".live-snippet__container");if(!e)return;let i=document.createElement("div");i.classList.add("live-snippet__loader"),i.innerHTML=`<svg class="spinner" viewBox="25 25 50 50">
				<circle class="path" cx="50" cy="50" r="20" fill="none" stroke-width="2" stroke-miterlimit="10"></circle>
			</svg>`,r.prepend(i),o.push({container:e,spinner:i,markDemoAsLoaded(){i.classList.add("fadeout"),e.classList.add("loaded")}})}),o}var vt=D("channelId"),g=D("userId"),S={name:St(),id:g,role:"writer"},A=class extends Me{static get requires(){return["Users","CommentsRepository"]}init(){let o=this.editor.plugins.get("Users"),r=this.editor.plugins.get("CommentsRepository");o.addUser(S),o.defineMe(S.id),r.adapter={addComment:()=>Promise.resolve(),updateComment:()=>Promise.resolve(),removeComment:()=>Promise.resolve(),getCommentThread:({threadId:e})=>{let i={"thread-1":{threadId:"thread-1",comments:[{commentId:"comment-1",authorId:g,content:"<p>What are some typical examples of Tier 2 cases?</p>",createdAt:new Date}]},"thread-2":{threadId:"thread-2",comments:[{commentId:"comment-1",authorId:g,content:"<p>Could we add one sentence explaining what qualifies as \u201Chigh-impact\u201D?</p>",createdAt:new Date}]},"thread-3":{threadId:"thread-3",comments:[{commentId:"comment-1",authorId:g,content:"<p>Can we add percentages for each category?</p>",createdAt:new Date}]},"thread-4":{threadId:"thread-4",comments:[{commentId:"comment-1",authorId:g,content:"<p>Can we add a short explanation here?</p>",createdAt:new Date}]}};return Promise.resolve(i[e])},addCommentThread:()=>Promise.resolve({comments:[]}),updateCommentThread:()=>Promise.resolve(),resolveCommentThread:()=>Promise.resolve({resolvedAt:new Date,resolvedBy:o.me.id}),reopenCommentThread:()=>Promise.resolve(),removeCommentThread:()=>Promise.resolve()}}},Tt=`<h1>Customer Support Metrics Report</h1>
...
`,data:"<h2>Introduction</h2><p>In today's fast-paced world, keeping up with the latest trends and insights is essential for both personal growth and professional development. This article aims to shed light on a topic that resonates with many, providing valuable information and actionable advice. Whether you're seeking to enhance your knowledge, improve your skills, or simply stay informed, our comprehensive analysis offers a deep dive into the subject matter, designed to empower and inspire our readers.</p>"}]}};t(o);let r=T()[0];return te.create(document.querySelector(".editor-content"),o).then(e=>(window.editor=e,document.querySelector(".menubar-container").appendChild(e.ui.view.menuBarView.element),document.querySelector(".toolbar-container").appendChild(e.ui.view.toolbar.element),r.markDemoAsLoaded(),L(e),e)).catch(e=>{console.error(e)})}function D(t){let o=location.search.match(new RegExp(`${t}=([^&]+)`)),r=o?decodeURIComponent(o[1]):null;if(!r){r=tt();let e=new URL(window.location.href);e.searchParams.set(t,r),window.history.replaceState({},document.title,e.toString())}return r}function St(){let t=["Alex","Jordan","Taylor","Casey","Morgan","Riley","Avery","Quinn","Sage","River"],o=["Smith","Johnson","Williams","Brown","Jones","Garcia","Miller","Davis","Rodriguez","Martinez"],r=t[Math.floor(Math.random()*t.length)],e=o[Math.floor(Math.random()*o.length)];return`${r} ${e}`}function R(t){let o;function r(){if(!t.commands.get("toggleAi").value){o?.destroy();return}let e=document.querySelector(".ck-ai-chat__prompt-input textarea");e&&(o=I({id:"ai-chat-overlay-input-tooltip",target:e,text:"You can talk with the AI chat here! Ask questions or request help with your content.",editor:t,tippyOptions:{placement:"top"}}))}t.commands.get("toggleAi").on("execute",()=>{r()},{priority:"low"}),r()}O(t=>{t.plugins=t.plugins.filter(o=>o.pluginName!=="AIReviewMode"&&o.pluginName!=="AITranslate")}).then(t=>{window.editor=t,R(t)});
