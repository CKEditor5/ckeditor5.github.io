var h="https://api.ckbox.io/token/demo";import{Plugin as ct}from"@ckeditor/ckeditor5-core";import{Essentials as pt}from"@ckeditor/ckeditor5-essentials";import{Autoformat as gt}from"@ckeditor/ckeditor5-autoformat";import{BlockQuote as ft}from"@ckeditor/ckeditor5-block-quote";import{Bold as _t,Italic as yt}from"@ckeditor/ckeditor5-basic-styles";import{Heading as It}from"@ckeditor/ckeditor5-heading";import{Image as Et,ImageCaption as Ct,ImageStyle as vt,ImageToolbar as wt}from"@ckeditor/ckeditor5-image";import{Indent as xt}from"@ckeditor/ckeditor5-indent";import{Link as Ot}from"@ckeditor/ckeditor5-link";import{List as At}from"@ckeditor/ckeditor5-list";import{MediaEmbed as Rt}from"@ckeditor/ckeditor5-media-embed";import{Paragraph as Dt}from"@ckeditor/ckeditor5-paragraph";import{Table as Mt,TableToolbar as Ut}from"@ckeditor/ckeditor5-table";function g({target:o,text:e,editor:t,tippyOptions:i}){if(!o){console.warn("[attachTourBalloon] The target DOM node for the feature tour balloon does not exist.",{text:e});return}if(!o.offsetParent){console.warn("[attachTourBalloon] The target DOM node is invisible and the balloon could not be attached.",{target:o,text:e});return}let a=`
		<div class="tippy-content__message">${e}</div>
		<button class="ck ck-button tippy-content__close-button ck-off" title="Close"></button>
	`,s=Object.assign({},{placement:"bottom",trigger:"manual",hideOnClick:!1,allowHTML:!0,maxWidth:280,showOnCreate:!0,interactive:!0,theme:"light-border",zIndex:1,appendTo:()=>document.body},i),n=window.umberto.createTooltip(o,a,s);for(let d of t.editing.view.document.roots)d.once("change:isFocused",(p,l,k)=>{k&&n.hide()});return n}function u(o,e){let t=o.items,i;return typeof e=="function"?i=t.find(e):i=t.get(e),i?i.element:void 0}function f(){let o=document.documentElement;return parseInt(window.getComputedStyle(o).getPropertyValue("--ck-snippet-viewport-top-offset"))}import{BalloonEditor as Qt,Essentials as Vt,CKFinderUploadAdapter as jt,Autoformat as Gt,BlockToolbar as Xt,Bold as Jt,Italic as Yt,BlockQuote as Zt,CKBox as $t,CKFinder as eo,EasyImage as to,Heading as oo,Image as io,ImageCaption as ao,ImageStyle as ro,ImageToolbar as so,ImageUpload as no,PictureEditing as lo,Indent as co,Link as mo,List as po,MediaEmbed as ho,Paragraph as go,PasteFromOffice as uo,Table as fo,TableToolbar as bo,TextTransformation as _o,CloudServices as yo}from"ckeditor5";import{BalloonEditor as Eo,Essentials as Co,CKFinderUploadAdapter as vo,Autoformat as wo,Bold as ko,Italic as xo,BlockQuote as Po,CKBox as Oo,CKFinder as Lo,EasyImage as Ao,Heading as Bo,Image as Ro,ImageCaption as Fo,ImageStyle as Do,ImageToolbar as Wo,ImageUpload as Mo,PictureEditing as Uo,Indent as No,Link as zo,List as Ho,MediaEmbed as Ko,Paragraph as qo,PasteFromOffice as Qo,Table as Vo,TableToolbar as jo,TextTransformation as Go,CloudServices as Xo}from"ckeditor5";import{ClassicEditor as $o,Essentials as ei,Autoformat as ti,Bold as oi,Italic as ii,BlockQuote as ai,CKBox as ri,EasyImage as si,Heading as ni,Image as li,ImageCaption as di,ImageStyle as ci,ImageToolbar as mi,ImageUpload as pi,PictureEditing as hi,Indent as gi,Link as ui,List as fi,MediaEmbed as bi,Paragraph as _i,PasteFromOffice as yi,Table as Ti,TableToolbar as Ii,TextTransformation as Si,CloudServices as Ei,AutoImage as Ci,ImageInsert as vi,Bookmark as wi}from"ckeditor5";import{DecoupledEditor as Oi,Essentials as Li,Alignment as Ai,FontSize as Bi,FontFamily as Ri,FontColor as Fi,FontBackgroundColor as Di,Autoformat as Wi,Bold as Mi,Italic as Ui,Strikethrough as Ni,Underline as zi,BlockQuote as Hi,CKBox as Ki,EasyImage as qi,Heading as Qi,Image as Vi,ImageCaption as ji,ImageResize as Gi,ImageStyle as Xi,ImageToolbar as Ji,ImageUpload as Yi,PictureEditing as Zi,Indent as $i,IndentBlock as ea,Link as ta,List as oa,ListProperties as ia,MediaEmbed as aa,Paragraph as ra,PasteFromOffice as sa,Table as na,TableToolbar as la,TextTransformation as da,CloudServices as ca}from"ckeditor5";import{InlineEditor as ga,Essentials as ua,CKFinderUploadAdapter as fa,Autoformat as ba,Bold as _a,Italic as ya,BlockQuote as Ta,CKBox as Ia,CKFinder as Sa,EasyImage as Ea,Heading as Ca,Image as va,ImageCaption as wa,ImageStyle as ka,ImageToolbar as xa,ImageUpload as Pa,PictureEditing as Oa,Indent as La,Link as Aa,List as Ba,MediaEmbed as Ra,Paragraph as Fa,PasteFromOffice as Da,Table as Wa,TableToolbar as Ma,TextTransformation as Ua,CloudServices as Na}from"ckeditor5";import{MultiRootEditor as qa,Essentials as Qa,CKFinderUploadAdapter as Va,Autoformat as ja,Bold as Ga,Italic as Xa,BlockQuote as Ja,CKBox as Ya,CKFinder as Za,EasyImage as $a,Heading as er,Image as tr,ImageCaption as or,ImageStyle as ir,ImageToolbar as ar,ImageUpload as rr,PictureEditing as sr,Indent as nr,Link as lr,List as dr,MediaEmbed as cr,Paragraph as mr,PasteFromOffice as pr,Table as hr,TableToolbar as gr,TextTransformation as ur,CloudServices as fr}from"ckeditor5";import{DecoupledEditor as R,Alignment as F,Autoformat as D,BlockQuote as W,Bold as M,Code as U,Italic as N,Strikethrough as z,Subscript as H,Superscript as K,Underline as q,Bookmark as Q,CKBox as V,CKBoxImageEdit as j,CloudServices as G,CodeBlock as X,Essentials as J,FindAndReplace as Y,Font as Z,GeneralHtmlSupport as $,Heading as ee,Highlight as te,HorizontalLine as oe,HtmlEmbed as ie,MediaEmbed as ae,Image as re,ImageCaption as se,ImageInsert as ne,ImageResize as le,ImageStyle as de,ImageToolbar as ce,ImageUpload as me,AutoImage as pe,PictureEditing as he,Indent as ge,IndentBlock as ue,Link as fe,LinkImage as be,AutoLink as _e,List as ye,ListProperties as Te,Mention as Ie,PageBreak as Se,Paragraph as Ee,PasteFromOffice as Ce,RemoveFormat as ve,SpecialCharacters as we,SpecialCharactersEssentials as ke,Style as xe,Table as Pe,TableCaption as Oe,TableCellProperties as Le,TableColumnResize as Ae,TableProperties as Be,TableToolbar as Re,TextTransformation as Fe,Fullscreen as De}from"ckeditor5";import{ExportPdf as We,ExportWord as Me,FormatPainter as Ue,ImportWord as Ne,MultiLevelList as ze,Pagination as He,PasteFromOfficeEnhanced as Ke,SlashCommand as qe,TableOfContents as Qe,DocumentOutline as Ve,Template as je,Comments as Ge,TrackChanges as Xe,TrackChangesPreview as Je,RevisionHistory as Ye,PresenceList as Ze,RealTimeCollaborativeRevisionHistory as $e,RealTimeCollaborativeTrackChanges as et,RealTimeCollaborativeEditing as tt,RealTimeCollaborativeComments as ot}from"ckeditor5-premium-features";import{Command as v,Plugin as w}from"@ckeditor/ckeditor5-core/dist/index.js";import{createDropdown as x,addListToDropdown as P,ViewModel as O}from"@ckeditor/ckeditor5-ui/dist/index.js";import{Collection as L}from"@ckeditor/ckeditor5-utils/dist/index.js";var A=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><polygon points="10.46 17.747 7.014 14.292 8.076 13.232 10.461 15.624 16.377 9.708 17.437 10.768 10.46 17.747"/><path d="M10.147,12.276c.063.153.138.331.226.531a2.7,2.7,0,0,0,.144.286L12,11.614l-.01-.027L9.4,5.189c-.122-.321-.222-.576-.3-.768A2.871,2.871,0,0,0,8.8,3.883a1.355,1.355,0,0,0-.453-.409,1.4,1.4,0,0,0-.7-.159,1.387,1.387,0,0,0-.693.159,1.314,1.314,0,0,0-.453.416,3.4,3.4,0,0,0-.325.646L5.92,5.2,3.383,11.641c-.1.257-.178.457-.223.6a1.4,1.4,0,0,0-.067.419.852.852,0,0,0,.29.629.941.941,0,0,0,.67.277.756.756,0,0,0,.643-.26,4.432,4.432,0,0,0,.473-1l.473-1.272H9.673ZM6.17,9.524,7.638,5.432,9.132,9.524Z"/></svg>
`,_=class extends v{execute(){this.editor.plugins.get("WProofreader").toggle()}},y=class extends v{execute(){this.editor.plugins.get("WProofreader").openSettings()}},T=class extends v{execute(){this.editor.plugins.get("WProofreader").openDialog()}},I=class extends w{static get pluginName(){return"WProofreaderEditing"}init(){this._addCommands()}afterInit(){this._enableInModes([{modeName:"TrackChanges",editingName:"TrackChangesEditing"},{modeName:"RestrictedEditingMode",editingName:"RestrictedEditingModeEditing"}])}_addCommands(){this.editor.commands.add("WProofreaderToggle",new _(this.editor)),this.editor.commands.add("WProofreaderSettings",new y(this.editor)),this.editor.commands.add("WProofreaderDialog",new T(this.editor))}_enableInModes(e){e.forEach(t=>{this._enableInMode(t.modeName,t.editingName)})}_enableInMode(e,t){if(this.editor.plugins.has(e)){let a=this.editor.plugins.get(t);["WProofreaderToggle","WProofreaderSettings","WProofreaderDialog"].forEach(n=>a.enableCommand(n))}}},S=class extends w{static get pluginName(){return"WProofreaderUI"}constructor(e){super(e),this._commands={toggle:"WProofreaderToggle",settings:"WProofreaderSettings",proofreadDialog:"WProofreaderDialog"}}init(){this._registerDropdown()}_registerDropdown(){let e=this.editor,t=e.plugins.get("WProofreader");e.ui.componentFactory.add("wproofreader",i=>{let a=x(i),s,n;return a.buttonView.set({label:"WProofreader text checker",icon:A,tooltip:!0}),a.on("change:isOpen",()=>{let d=t.isInstancesReady(),p=t.isInstancesEnabled();if(!d){a.class="ck-wproofreader-empty";return}s||(n=t.getStaticActions(),s=this._getDropdownItemsDefinitions(n),P(a,s)),a.class="",s.map(l=>{l.model.class=p?"":"ck-hidden",l.model.commandParam==="WProofreaderToggle"&&(l.model.label=p?l.model.localization.disable:l.model.localization.enable,l.model.class="")})}),a.on("execute",d=>{e.execute(d.source.commandParam)}),a.bind("isEnabled").to(e.commands.get("WProofreaderToggle")),a})}_getDropdownItemsDefinitions(e){let t=new L;return e.forEach(i=>{let a={type:"button",model:new O({commandParam:this._commands[i.name],label:i.localization.default,localization:i.localization,class:"",withText:!0})};t.add(a)}),t}},E=class{constructor(){this._create()}_create(){window.WPROOFREADER_SRCSTORAGE=window.WPROOFREADER_SRCSTORAGE||{},this._storage=window.WPROOFREADER_SRCSTORAGE}has(e){return!!this._storage[e]}add(e){this._storage[e]={onLoad:[],onError:[]}}addCallbacks(e,t,i){this._storage[e].onLoad.push(t),this._storage[e].onError.push(i)}eachOnLoad(e,t){this._storage[e].onLoad.forEach(t)}eachOnError(e,t){this._storage[e].onError.forEach(t)}delete(e){delete this._storage[e]}get(e){return this._storage[e]}},C=class{constructor(e){this._validateSrc(e),this._src=e,this._globalSrcStorage=new E}load(){return new Promise((e,t)=>{this._isScriptOnPage()?this._processExistingScript(e,t):this._createScript(e,t)})}_validateSrc(e){if(!e)throw new Error("Path to the script is not specified.")}_isScriptOnPage(){return!!document.querySelector('script[src="'+this._src+'"]')}_createScript(e,t){this._script=this._createElement(),this._globalSrcStorage.add(this._src),this._globalSrcStorage.addCallbacks(this._src,e,t),this._subscribeOnScriptLoad(),this._subscribeOnScriptError(),this._appendScript(this._script)}_createElement(){let e=document.createElement("script");return e.type="text/javascript",e.charset="UTF-8",e.src=this._src,e}_subscribeOnScriptLoad(){this._script.onload=()=>{this._globalSrcStorage.eachOnLoad(this._src,e=>{e()}),this._destroy()}}_subscribeOnScriptError(){this._script.onerror=()=>{let e=new Error(`${this._src} failed to load.`);this._globalSrcStorage.eachOnError(this._src,t=>{t(e)}),this._destroy()}}_destroy(){this._removeListeners(),this._globalSrcStorage.delete(this._src),this._src=null,this._script=null}_removeListeners(){this._script.onload=null,this._script.onerror=null}_appendScript(e){document.getElementsByTagName("head")[0].appendChild(e)}_processExistingScript(e,t){this._globalSrcStorage.has(this._src)?this._addCallbacks(e,t):this._processLoadedScript(e)}_addCallbacks(e,t){this._globalSrcStorage.addCallbacks(this._src,e,t)}_processLoadedScript(e){e()}},B="WProofreaderToggleCommandDisabling",b="InstancesDisabling",c=class extends w{static get requires(){return[I,S]}static get pluginName(){return"WProofreader"}constructor(e){super(e),this.set("isToggleCommandEnabled",!0),this._instances=[],this._restrictedEditingName="RestrictedEditingMode"}init(){this._userOptions=this._getUserOptions(),this._setTheme(),this._setAutoStartup(),this._setBadgeOffset(),this._setIsEnabled(this._userOptions.autoStartup,b),this._loadWscbundle().then(()=>{this._handleWscbundleLoaded()}).catch(e=>{throw new Error(e)}),this.bind("isToggleCommandEnabled").to(this.editor.commands.get("WProofreaderToggle"),"isEnabled",e=>this._handleToggleCommandEnabled(e))}destroy(){super.destroy(),this._instances.forEach(e=>e.destroy()),this._instances=null}_getUserOptions(){let e=this.editor.config.get("wproofreader");if(!e)throw new Error("No WProofreader configuration.");return e}_setTheme(){this._userOptions.theme||(this._userOptions.theme="ckeditor5")}_setAutoStartup(){Object.prototype.hasOwnProperty.call(this._userOptions,"autoStartup")||(this._userOptions.autoStartup=!0)}_setBadgeOffset(){this._userOptions.fullSizeBadge||(Object.prototype.hasOwnProperty.call(this._userOptions,"badgeOffsetX")||(this._userOptions.badgeOffsetX=11),Object.prototype.hasOwnProperty.call(this._userOptions,"badgeOffsetY")||(this._userOptions.badgeOffsetY=11))}_setIsEnabled(e,t){e?this.clearForceDisabled(t):this.forceDisabled(t)}_loadWscbundle(){return new C(this._userOptions.srcUrl).load()}_handleWscbundleLoaded(){this.editor.state==="ready"?this._createInstances():this._subscribeOnEditorReady()}_createInstances(){let e=this.editor.editing.view.domRoots.values();this._setFields();for(let t of e)this._createInstance(t)}_setFields(){this._isRestrictedEditingMode=this._checkRestrictedEditingMode(),this._options=this._createOptions()}_checkRestrictedEditingMode(){return this.editor.plugins.has(this._restrictedEditingName)}_createOptions(){return{appType:"proofreader_ck5",restrictedEditingMode:this._isRestrictedEditingMode,disableBadgePulsing:!0,onCommitOptions:this._onCommitOptions.bind(this),onToggle:this._onToggle.bind(this)}}_onCommitOptions(e){this._syncOptions(e)}_syncOptions(e){this._instances.forEach(t=>{t.commitOption(e,{ignoreCallback:!0})})}_onToggle(e){let t=!e.isDisabled();this._setIsEnabled(t,b),this._syncToggle(t)}_syncToggle(e){this._instances.forEach(t=>{e?this._enableInstance(t):this._disableInstance(t)})}_enableInstance(e){let t={ignoreCallback:!0};this.isEnabled&&e.enable(t)}_disableInstance(e){let t={ignoreCallback:!0};e.disable(t)}_createInstance(e){WEBSPELLCHECKER.init(this._mergeOptions(e),this._handleInstanceCreated.bind(this))}_mergeOptions(e){return Object.assign({},this._userOptions,this._options,{container:e})}_handleInstanceCreated(e){if(e){if(this.editor.state==="destroyed"){e.destroy();return}this.isEnabled||this._disableInstance(e),this._instances.push(e)}}_subscribeOnEditorReady(){this.editor.on("ready",()=>{this._createInstances()})}_handleToggleCommandEnabled(e){return this._setIsEnabled(e,B),this._syncToggle(e),e}getStaticActions(){return this._instances.length===0?[]:this._instances[0].getStaticActions()}toggle(){if(this._instances.length===0)return;let e=this.isInstancesEnabled();this._setIsEnabled(!e,b),this._syncToggle(!e)}openSettings(){this._instances.length!==0&&this._instances[0].openSettings()}openDialog(){this._instances.length!==0&&this._instances[0].openDialog()}isInstancesReady(){return this._instances.length>0}isInstancesEnabled(){return this._instances.length===0?!1:!this._instances[0].isDisabled()}};var m=class extends R{static builtinPlugins=[D,W,M,Q,ee,re,se,Ue,De,de,ce,ge,N,fe,ye,ae,Ee,Pe,Re,F,pe,_e,V,j,G,U,X,J,We,Me,Ne,Y,Z,te,oe,ie,ne,le,me,ue,$,be,Te,ze,Ie,Se,He,Ce,Ke,he,ve,qe,we,ke,xe,z,H,K,Oe,Le,Ae,Be,Qe,je,Fe,q,c,Ve,Ze,Ge,Xe,Je,Ye,ot,tt,et,$e]};var it={tokenUrl:"https://33333.cke-cs.com/token/dev/dbIg4Hr2bqf5bSV3wuzN8bW8td7OAStvLjRlJof9ZW13cUXRHRraVJsD8J9J",uploadUrl:"https://33333.cke-cs.com/easyimage/upload/",webSocketUrl:"33333.cke-cs.com/ws"},at=`
