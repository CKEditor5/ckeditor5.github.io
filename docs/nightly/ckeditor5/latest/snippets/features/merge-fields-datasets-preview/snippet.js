var w="https://33333.cke-cs.com/token/dev/ijrDsqFix838Gh3wGO3F77FSW94BwcLXprJ4APSp3XQ26xsUHTi0jcb1hoBt",I="https://33333.cke-cs.com/easyimage/upload/",S="33333.cke-cs.com/ws",d={tokenUrl:w,uploadUrl:I,webSocketUrl:S};var c="https://api.ckbox.io/token/demo";import{Plugin as Ze}from"@ckeditor/ckeditor5-core";import{Essentials as tt}from"@ckeditor/ckeditor5-essentials";import{Autoformat as at}from"@ckeditor/ckeditor5-autoformat";import{BlockQuote as rt}from"@ckeditor/ckeditor5-block-quote";import{Bold as st,Italic as nt}from"@ckeditor/ckeditor5-basic-styles";import{Heading as ct}from"@ckeditor/ckeditor5-heading";import{Image as mt,ImageCaption as gt,ImageStyle as ut,ImageToolbar as ft}from"@ckeditor/ckeditor5-image";import{Indent as ht}from"@ckeditor/ckeditor5-indent";import{Link as xt}from"@ckeditor/ckeditor5-link";import{List as Tt}from"@ckeditor/ckeditor5-list";import{MediaEmbed as It}from"@ckeditor/ckeditor5-media-embed";import{Paragraph as Et}from"@ckeditor/ckeditor5-paragraph";import{Table as vt,TableToolbar as Lt}from"@ckeditor/ckeditor5-table";function p({id:e,target:t,text:a,editor:i,tippyOptions:b}){if(!t){console.warn("[attachTourBalloon] The target DOM node for the feature tour balloon does not exist.",{text:a});return}if(!t.offsetParent){console.warn("[attachTourBalloon] The target DOM node is invisible and the balloon could not be attached.",{target:t,text:a});return}let h=window.umberto.Tooltip.create({id:e,text:a,trigger:t,mode:"click",variant:"dark",icon:"bulb",disableOnMobile:!1,showCloseButton:!0,showAfterMount:!0,hideOnOutsideClick:!1,destroyOnHide:!0,...b?.placement&&{position:b.placement}});for(let k of i.editing.view.document.roots)k.once("change:isFocused",(Xe,ze,T)=>{T&&h.destroy()});return h}function m(e,t){let a=e.items,i;return typeof t=="function"?i=a.find(t):i=a.get(t),i?i.element:void 0}function g(){let e=document.documentElement;return parseInt(window.getComputedStyle(e).getPropertyValue("--ck-snippet-viewport-top-offset"))}import{BalloonEditor as Rt,Essentials as Ft,Autoformat as Ot,BlockToolbar as Mt,Bold as Nt,Italic as Vt,BlockQuote as Ut,CKBox as Gt,Heading as Kt,Image as Ht,ImageCaption as qt,ImageStyle as Qt,ImageToolbar as Xt,ImageUpload as zt,PictureEditing as Wt,Indent as jt,IndentBlock as Jt,Link as $t,List as Yt,MediaEmbed as Zt,Paragraph as eo,PasteFromOffice as to,Table as oo,TableToolbar as ao,TextTransformation as io,CloudServices as ro}from"ckeditor5";import{BalloonEditor as co,Essentials as po,Autoformat as mo,Bold as go,Italic as uo,BlockQuote as fo,CKBox as bo,Heading as ho,Image as yo,ImageCaption as xo,ImageStyle as ko,ImageToolbar as To,ImageUpload as wo,PictureEditing as Io,Indent as So,IndentBlock as Eo,Link as Co,List as vo,MediaEmbed as Lo,Paragraph as _o,PasteFromOffice as Po,Table as Do,TableToolbar as Bo,TextTransformation as Ao,CloudServices as Ro}from"ckeditor5";import{ClassicEditor as E,Essentials as C,Autoformat as v,Bold as L,Italic as _,BlockQuote as P,CKBox as D,Heading as B,Image as A,ImageCaption as R,ImageStyle as F,ImageToolbar as O,ImageUpload as M,PictureEditing as N,Indent as V,IndentBlock as U,Link as G,List as K,MediaEmbed as H,Paragraph as q,PasteFromOffice as Q,Table as X,TableToolbar as z,TextTransformation as W,CloudServices as j,AutoImage as J,ImageInsert as $,Bookmark as Y}from"ckeditor5";var r=class extends E{static builtinPlugins=[C,v,L,_,P,j,B,A,R,F,O,M,D,V,U,G,K,H,q,Q,N,X,z,W,J,$,Y];static defaultConfig={toolbar:{items:["undo","redo","|","heading","|","bold","italic","|","link","uploadImage","insertTable","blockQuote","mediaEmbed","|","bulletedList","numberedList","outdent","indent"]},image:{toolbar:["imageStyle:inline","imageStyle:block","imageStyle:wrapText","|","toggleImageCaption","imageTextAlternative"]},table:{contentToolbar:["tableColumn","tableRow","mergeTableCells"]},list:{enableSkipLevelLists:!0},language:"en"}};import{DecoupledEditor as Go,Essentials as Ko,Alignment as Ho,FontSize as qo,FontFamily as Qo,FontColor as Xo,FontBackgroundColor as zo,Autoformat as Wo,Bold as jo,Italic as Jo,Strikethrough as $o,Underline as Yo,BlockQuote as Zo,CKBox as ea,Heading as ta,Image as oa,ImageCaption as aa,ImageResize as ia,ImageStyle as ra,ImageToolbar as la,ImageUpload as sa,PictureEditing as na,Indent as da,IndentBlock as ca,Link as pa,List as ma,ListProperties as ga,MediaEmbed as ua,Paragraph as fa,PasteFromOffice as ba,Table as ha,TableToolbar as ya,TextTransformation as xa,CloudServices as ka}from"ckeditor5";import{InlineEditor as Sa,Essentials as Ea,Autoformat as Ca,Bold as va,Italic as La,BlockQuote as _a,CKBox as Pa,Heading as Da,Image as Ba,ImageCaption as Aa,ImageStyle as Ra,ImageToolbar as Fa,ImageUpload as Oa,PictureEditing as Ma,Indent as Na,IndentBlock as Va,Link as Ua,List as Ga,MediaEmbed as Ka,Paragraph as Ha,PasteFromOffice as qa,Table as Qa,TableToolbar as Xa,TextTransformation as za,CloudServices as Wa}from"ckeditor5";import{MultiRootEditor as Ya,Essentials as Za,Autoformat as ei,Bold as ti,Italic as oi,BlockQuote as ai,CKBox as ii,Heading as ri,Image as li,ImageCaption as si,ImageStyle as ni,ImageToolbar as di,ImageUpload as ci,PictureEditing as pi,Indent as mi,IndentBlock as gi,Link as ui,List as fi,MediaEmbed as bi,Paragraph as hi,PasteFromOffice as yi,Table as xi,TableToolbar as ki,TextTransformation as Ti,CloudServices as wi}from"ckeditor5";import{Alignment as Z,Autoformat as ee,Bold as te,Italic as oe,Underline as ae,BlockQuote as ie,CKBox as re,CKBoxImageEdit as le,CloudServices as se,Essentials as ne,FontBackgroundColor as de,FontColor as ce,FontFamily as pe,FontSize as me,Heading as ge,Indent as ue,IndentBlock as fe,PictureEditing as be,Image as he,ImageCaption as ye,ImageInsert as xe,ImageResize as ke,ImageStyle as Te,ImageToolbar as we,ImageUpload as Ie,Link as Se,List as Ee,MediaEmbed as Ce,PageBreak as ve,Paragraph as Le,PasteFromOffice as _e,SpecialCharacters as Pe,SpecialCharactersEssentials as De,Table as Be,TableCellProperties as Ae,TableProperties as Re,TableToolbar as Fe,TextTransformation as Oe,CodeBlock as Me,Mention as Ne,Plugin as zi}from"ckeditor5";import{SourceEditingEnhanced as Ve,ExportPdf as Ue,ExportWord as Ge,ImportWord as Ke,MergeFields as He,Template as qe}from"ckeditor5-premium-features";var s="19.25mm",n="16mm",l=class extends r{static builtinPlugins=[...r.builtinPlugins,He,Ne,Z,ne,ee,ie,te,re,le,Me,ge,be,he,ye,Te,we,ue,oe,Se,Ee,Le,Be,Fe,Ue,Ge,Ke,me,pe,ce,de,fe,Ie,xe,ke,Ce,ve,_e,Pe,De,Ve,Re,Ae,Oe,ae,se,qe];static defaultConfig={mergeFields:{prefix:"{{",suffix:"}}",previewHtmlValues:!0,sanitizeHtml:t=>({html:t,hasChanged:!1}),definitions:[{groupId:"guestInformation",groupLabel:"Guest information",definitions:[{id:"guestTitle",label:"Title",defaultValue:"Mr./Mrs."},{id:"guestName",label:"Name",defaultValue:"John"},{id:"guestLastName",label:"Last name",defaultValue:"Doe"},{id:"discount",label:"Guest discount",defaultValue:"0%"},{id:"hotelRoomPhoto",label:"Hotel room photo",type:"image",width:600,height:400,defaultValue:"https://ckeditor.com/assets/images/ckdemo/merge-fields/hotel-room2.jpg"}]},{groupId:"reservationInformation",groupLabel:"Reservation information",definitions:[{id:"reservationNumber",label:"Reservation number",defaultValue:"0000"},{id:"arrivalDate",label:"Arrival date",defaultValue:()=>new Date().toLocaleDateString()},{id:"numberOfNights",label:"Number of nights",defaultValue:"0"},{id:"numberOfGuests",label:"Number of guests",defaultValue:"0"},{id:"roomType",label:"Room type",defaultValue:"Single room"},{id:"complimentaryDuration",label:"Complimentary duration",defaultValue:"60 min"},{id:"reservationDetails",label:"Reservation details",defaultValue:`
...
`,x=[{id:"78900",label:"David Lee",values:{guestTitle:"Mr.",guestName:"David",guestLastName:"Lee",hotelRoomPhoto:"https://ckeditor.com/assets/images/ckdemo/merge-fields/hotel-room2.jpg",reservationNumber:"Y2JKH5G1Z",arrivalDate:new Date(2024,7,22).toLocaleDateString(),numberOfGuests:"2",numberOfNights:"6",roomType:"Double Room",discount:"20%",complimentaryDuration:"15 min",feedbackSurvey:'<a href="https://ckeditor.com/docs/ckeditor5/latest/features/merge-fields.html">quick survey</a>',resortPhone:"555-232-2334-23",reservationDetails:`
				...
				</figure>`}}];var Qe={dataSets:x,previewModes:["$labels","$dataSets"]};l.create({attachTo:document.querySelector("#snippet-merge-fields-datasets"),mergeFields:{...l.defaultConfig.mergeFields,...Qe},toolbar:{items:["insertMergeField","previewMergeFields"].concat(l.defaultConfig.toolbar.items)},root:{initialData:y}}).then(e=>{window.editor=e,window.preventPasteFromOfficeNotification=!0,p({target:m(e.ui.view.toolbar,t=>t.buttonView&&t.buttonView.label==="Merge fields preview"),text:"Click to change preview mode.",editor:e,tippyOptions:{placement:"bottom-start"}})}).catch(e=>{console.error(e.stack)});
