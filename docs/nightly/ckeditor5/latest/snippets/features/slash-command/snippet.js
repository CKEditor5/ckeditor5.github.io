import{Bold as ae,Code as re,Italic as ne,Underline as de,BlockQuote as se,CKBox as ce,CKBoxImageEdit as me,CodeBlock as pe,Font as ge,Heading as fe,HorizontalLine as he,GeneralHtmlSupport as ue,HtmlEmbed as be,ImageInsert as xe,ImageResize as _e,ImageUpload as ye,TodoList as ke,Mention as Be,Style as Ce,TableProperties as we,TableCellProperties as Ie}from"ckeditor5";import{SlashCommand as Te,Template as Se,TableOfContents as Ae}from"ckeditor5-premium-features";var l="https://api.ckbox.io/token/demo";import{Plugin as s}from"@ckeditor/ckeditor5-core";import{Essentials as c}from"@ckeditor/ckeditor5-essentials";import{Autoformat as m}from"@ckeditor/ckeditor5-autoformat";import{BlockQuote as p}from"@ckeditor/ckeditor5-block-quote";import{Bold as g,Italic as f}from"@ckeditor/ckeditor5-basic-styles";import{Heading as h}from"@ckeditor/ckeditor5-heading";import{Image as u,ImageCaption as b,ImageStyle as x,ImageToolbar as _}from"@ckeditor/ckeditor5-image";import{Indent as y}from"@ckeditor/ckeditor5-indent";import{Link as k}from"@ckeditor/ckeditor5-link";import{List as B}from"@ckeditor/ckeditor5-list";import{MediaEmbed as C}from"@ckeditor/ckeditor5-media-embed";import{Paragraph as w}from"@ckeditor/ckeditor5-paragraph";import{Table as I,TableToolbar as T}from"@ckeditor/ckeditor5-table";var o=class extends s{static get pluginName(){return"ArticlePluginSet"}static get requires(){return[c,m,p,g,h,u,b,x,_,y,f,k,B,C,w,I,T]}};function a(){let t=document.documentElement;return parseInt(window.getComputedStyle(t).getPropertyValue("--ck-snippet-viewport-top-offset"))}import{BalloonEditor as Je,Essentials as $e,CKFinderUploadAdapter as Ye,Autoformat as et,BlockToolbar as tt,Bold as ot,Italic as it,BlockQuote as lt,CKBox as at,CKFinder as rt,EasyImage as nt,Heading as dt,Image as st,ImageCaption as ct,ImageStyle as mt,ImageToolbar as pt,ImageUpload as gt,PictureEditing as ft,Indent as ht,IndentBlock as ut,Link as bt,List as xt,MediaEmbed as _t,Paragraph as yt,PasteFromOffice as kt,Table as Bt,TableToolbar as Ct,TextTransformation as wt,CloudServices as It}from"ckeditor5";import{BalloonEditor as Et,Essentials as Ft,CKFinderUploadAdapter as vt,Autoformat as Lt,Bold as Rt,Italic as Ot,BlockQuote as Pt,CKBox as Mt,CKFinder as Ut,EasyImage as Ht,Heading as Kt,Image as Dt,ImageCaption as Vt,ImageStyle as Gt,ImageToolbar as zt,ImageUpload as Qt,PictureEditing as qt,Indent as Nt,IndentBlock as Zt,Link as jt,List as Wt,MediaEmbed as Xt,Paragraph as Jt,PasteFromOffice as $t,Table as Yt,TableToolbar as eo,TextTransformation as to,CloudServices as oo}from"ckeditor5";import{ClassicEditor as S,Essentials as A,Autoformat as E,Bold as F,Italic as v,BlockQuote as L,CKBox as R,EasyImage as O,Heading as P,Image as M,ImageCaption as U,ImageStyle as H,ImageToolbar as K,ImageUpload as D,PictureEditing as V,Indent as G,IndentBlock as z,Link as Q,List as q,MediaEmbed as N,Paragraph as Z,PasteFromOffice as j,Table as W,TableToolbar as X,TextTransformation as J,CloudServices as $,AutoImage as Y,ImageInsert as ee,Bookmark as te}from"ckeditor5";var i=class extends S{static builtinPlugins=[A,E,F,v,L,$,O,P,M,U,H,K,D,R,G,z,Q,q,N,Z,j,V,W,X,J,Y,ee,te];static defaultConfig={toolbar:{items:["undo","redo","|","heading","|","bold","italic","|","link","uploadImage","insertTable","blockQuote","mediaEmbed","|","bulletedList","numberedList","outdent","indent"]},image:{toolbar:["imageStyle:inline","imageStyle:block","imageStyle:wrapText","|","toggleImageCaption","imageTextAlternative"]},table:{contentToolbar:["tableColumn","tableRow","mergeTableCells"]},language:"en"}};import{DecoupledEditor as co,Essentials as mo,Alignment as po,FontSize as go,FontFamily as fo,FontColor as ho,FontBackgroundColor as uo,Autoformat as bo,Bold as xo,Italic as _o,Strikethrough as yo,Underline as ko,BlockQuote as Bo,CKBox as Co,EasyImage as wo,Heading as Io,Image as To,ImageCaption as So,ImageResize as Ao,ImageStyle as Eo,ImageToolbar as Fo,ImageUpload as vo,PictureEditing as Lo,Indent as Ro,IndentBlock as Oo,Link as Po,List as Mo,ListProperties as Uo,MediaEmbed as Ho,Paragraph as Ko,PasteFromOffice as Do,Table as Vo,TableToolbar as Go,TextTransformation as zo,CloudServices as Qo}from"ckeditor5";import{InlineEditor as jo,Essentials as Wo,CKFinderUploadAdapter as Xo,Autoformat as Jo,Bold as $o,Italic as Yo,BlockQuote as ei,CKBox as ti,CKFinder as oi,EasyImage as ii,Heading as li,Image as ai,ImageCaption as ri,ImageStyle as ni,ImageToolbar as di,ImageUpload as si,PictureEditing as ci,Indent as mi,IndentBlock as pi,Link as gi,List as fi,MediaEmbed as hi,Paragraph as ui,PasteFromOffice as bi,Table as xi,TableToolbar as _i,TextTransformation as yi,CloudServices as ki}from"ckeditor5";import{MultiRootEditor as Ii,Essentials as Ti,CKFinderUploadAdapter as Si,Autoformat as Ai,Bold as Ei,Italic as Fi,BlockQuote as vi,CKBox as Li,CKFinder as Ri,EasyImage as Oi,Heading as Pi,Image as Mi,ImageCaption as Ui,ImageStyle as Hi,ImageToolbar as Ki,ImageUpload as Di,PictureEditing as Vi,Indent as Gi,IndentBlock as zi,Link as Qi,List as qi,MediaEmbed as Ni,Paragraph as Zi,PasteFromOffice as ji,Table as Wi,TableToolbar as Xi,TextTransformation as Ji,CloudServices as $i}from"ckeditor5";var r=`<svg width="45" height="45" viewBox="0 0 45 45" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`;i.create(document.querySelector("#snippet-slash-command"),{extraPlugins:[o,se,ae,re,ce,me,pe,ge,ue,fe,he,be,xe,_e,ye,ne,Be,Te,Ce,Ie,Ae,we,Se,ke,de],removePlugins:["CKFinder"],toolbar:{items:["undo","redo","|","style","|","heading","|","fontColor","fontBackgroundColor","|","bold","italic","underline","-","insertTable","insertImage","ckbox","blockquote","codeBlock","htmlEmbed","insertTemplate","tableOfContents","|","numberedList","bulletedList","todoList","indent","outdent"],shouldNotGroupWhenFull:!0},template:{definitions:[{title:"Document with an image",icon:r,description:"Simple heading with text and an image.",data:`<h2>Title of the document</h2>
					...
					</figure>`},{title:"To-do list",icon:d,description:"A simple to-do list to keep track of things.",data:`
						<h2>My to-do list</h2>
						<h3>Today</h3>
						<ul class="todo-list">
							<li>
