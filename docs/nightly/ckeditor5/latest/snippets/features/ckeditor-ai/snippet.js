import{Alignment as j,Autoformat as M,AutoImage as G,AutoLink as $,Autosave as J,BalloonToolbar as Z,BlockQuote as X,Bold as U,Bookmark as Y,CKBox as ee,CKBoxImageEdit as te,CloudServices as oe,Code as ie,DecoupledEditor as re,Emoji as ne,Essentials as ae,FindAndReplace as se,FontBackgroundColor as le,FontColor as de,FontFamily as ce,FontSize as me,Fullscreen as pe,GeneralHtmlSupport as ue,Heading as ge,HorizontalLine as he,ImageBlock as fe,ImageCaption as be,ImageEditing as ye,ImageInline as we,ImageInsert as ke,ImageInsertViaUrl as ve,ImageResize as Ce,ImageStyle as Ie,ImageTextAlternative as xe,ImageToolbar as Te,ImageUpload as Se,ImageUtils as Ae,Indent as Ee,IndentBlock as Le,Italic as R,Link as Be,LinkImage as _e,List as Pe,ListProperties as Fe,Mention as De,Paragraph as Me,PasteFromOffice as Ue,PictureEditing as Re,Plugin as Oe,RemoveFormat as qe,SpecialCharacters as He,SpecialCharactersArrows as ze,SpecialCharactersCurrency as We,SpecialCharactersEssentials as Ke,SpecialCharactersLatin as Ne,SpecialCharactersMathematical as Ve,SpecialCharactersText as Qe,Strikethrough as je,Subscript as Ge,Superscript as $e,Table as Je,TableCaption as Ze,TableCellProperties as Xe,TableColumnResize as Ye,TableProperties as et,TableToolbar as tt,TextTransformation as ot,TodoList as it,Underline as rt}from"ckeditor5";var W="https://33333.cke-cs.com/token/dev/ijrDsqFix838Gh3wGO3F77FSW94BwcLXprJ4APSp3XQ26xsUHTi0jcb1hoBt",K="https://33333.cke-cs.com/easyimage/upload/",N="33333.cke-cs.com/ws",y={tokenUrl:W,uploadUrl:K,webSocketUrl:N};var k="https://api.ckbox.io/token/demo";import{Plugin as qt}from"@ckeditor/ckeditor5-core";import{Essentials as zt}from"@ckeditor/ckeditor5-essentials";import{Autoformat as Kt}from"@ckeditor/ckeditor5-autoformat";import{BlockQuote as Vt}from"@ckeditor/ckeditor5-block-quote";import{Bold as jt,Italic as Gt}from"@ckeditor/ckeditor5-basic-styles";import{Heading as Jt}from"@ckeditor/ckeditor5-heading";import{Image as Xt,ImageCaption as Yt,ImageStyle as eo,ImageToolbar as to}from"@ckeditor/ckeditor5-image";import{Indent as io}from"@ckeditor/ckeditor5-indent";import{Link as no}from"@ckeditor/ckeditor5-link";import{List as so}from"@ckeditor/ckeditor5-list";import{MediaEmbed as co}from"@ckeditor/ckeditor5-media-embed";import{Paragraph as po}from"@ckeditor/ckeditor5-paragraph";import{Table as go,TableToolbar as ho}from"@ckeditor/ckeditor5-table";function v({id:t,target:o,text:i,editor:e,tippyOptions:r}){if(!o){console.warn("[attachTourBalloon] The target DOM node for the feature tour balloon does not exist.",{text:i});return}if(!o.offsetParent){console.warn("[attachTourBalloon] The target DOM node is invisible and the balloon could not be attached.",{target:o,text:i});return}let a=window.umberto.Tooltip.create({id:t,text:i,trigger:o,mode:"click",variant:"dark",icon:"bulb",disableOnMobile:!1,showCloseButton:!0,showAfterMount:!0,hideOnOutsideClick:!1,destroyOnHide:!0,...r?.placement&&{position:r.placement}});for(let l of e.editing.view.document.roots)l.once("change:isFocused",(d,c,m)=>{m&&a.destroy()});return a}function C(t,o){let i=t.items,e;return typeof o=="function"?e=i.find(o):e=i.get(o),e?e.element:void 0}function I(){let t=document.documentElement;return parseInt(window.getComputedStyle(t).getPropertyValue("--ck-snippet-viewport-top-offset"))}function w(t){return document.querySelector(`link[href*="${t}/snippet.css"][data-cke]`)?.href||""}import{BalloonEditor as vo,Essentials as Co,Autoformat as Io,BlockToolbar as xo,Bold as To,Italic as So,BlockQuote as Ao,CKBox as Eo,Heading as Lo,Image as Bo,ImageCaption as _o,ImageStyle as Po,ImageToolbar as Fo,ImageUpload as Do,PictureEditing as Mo,Indent as Uo,IndentBlock as Ro,Link as Oo,List as qo,MediaEmbed as Ho,Paragraph as zo,PasteFromOffice as Wo,Table as Ko,TableToolbar as No,TextTransformation as Vo,CloudServices as Qo}from"ckeditor5";import{BalloonEditor as Jo,Essentials as Zo,Autoformat as Xo,Bold as Yo,Italic as ei,BlockQuote as ti,CKBox as oi,Heading as ii,Image as ri,ImageCaption as ni,ImageStyle as ai,ImageToolbar as si,ImageUpload as li,PictureEditing as di,Indent as ci,IndentBlock as mi,Link as pi,List as ui,MediaEmbed as gi,Paragraph as hi,PasteFromOffice as fi,Table as bi,TableToolbar as yi,TextTransformation as wi,CloudServices as ki}from"ckeditor5";import{ClassicEditor as xi,Essentials as Ti,Autoformat as Si,Bold as Ai,Italic as Ei,BlockQuote as Li,CKBox as Bi,Heading as _i,Image as Pi,ImageCaption as Fi,ImageStyle as Di,ImageToolbar as Mi,ImageUpload as Ui,PictureEditing as Ri,Indent as Oi,IndentBlock as qi,Link as Hi,List as zi,MediaEmbed as Wi,Paragraph as Ki,PasteFromOffice as Ni,Table as Vi,TableToolbar as Qi,TextTransformation as ji,CloudServices as Gi,AutoImage as $i,ImageInsert as Ji,Bookmark as Zi}from"ckeditor5";import{DecoupledEditor as tr,Essentials as or,Alignment as ir,FontSize as rr,FontFamily as nr,FontColor as ar,FontBackgroundColor as sr,Autoformat as lr,Bold as dr,Italic as cr,Strikethrough as mr,Underline as pr,BlockQuote as ur,CKBox as gr,Heading as hr,Image as fr,ImageCaption as br,ImageResize as yr,ImageStyle as wr,ImageToolbar as kr,ImageUpload as vr,PictureEditing as Cr,Indent as Ir,IndentBlock as xr,Link as Tr,List as Sr,ListProperties as Ar,MediaEmbed as Er,Paragraph as Lr,PasteFromOffice as Br,Table as _r,TableToolbar as Pr,TextTransformation as Fr,CloudServices as Dr}from"ckeditor5";import{InlineEditor as Or,Essentials as qr,Autoformat as Hr,Bold as zr,Italic as Wr,BlockQuote as Kr,CKBox as Nr,Heading as Vr,Image as Qr,ImageCaption as jr,ImageStyle as Gr,ImageToolbar as $r,ImageUpload as Jr,PictureEditing as Zr,Indent as Xr,IndentBlock as Yr,Link as en,List as tn,MediaEmbed as on,Paragraph as rn,PasteFromOffice as nn,Table as an,TableToolbar as sn,TextTransformation as ln,CloudServices as dn}from"ckeditor5";import{MultiRootEditor as un,Essentials as gn,Autoformat as hn,Bold as fn,Italic as bn,BlockQuote as yn,CKBox as wn,Heading as kn,Image as vn,ImageCaption as Cn,ImageStyle as In,ImageToolbar as xn,ImageUpload as Tn,PictureEditing as Sn,Indent as An,IndentBlock as En,Link as Ln,List as Bn,MediaEmbed as _n,Paragraph as Pn,PasteFromOffice as Fn,Table as Dn,TableToolbar as Mn,TextTransformation as Un,CloudServices as Rn}from"ckeditor5";import{AIChat as nt,AIEditorIntegration as at,AIQuickActions as st,AIReviewMode as lt,AITranslate as dt,CaseChange as ct,Comments as mt,CommentsRepository as pt,ExportPdf as ut,ExportWord as gt,Footnotes as ht,FormatPainter as ft,ImportWord as bt,LineHeight as yt,MultiLevelList as wt,PasteFromOfficeEnhanced as kt,SlashCommand as vt,TableOfContents as Ct,Template as It,TrackChanges as xt,TrackChangesData as Tt,TrackChangesPreview as St,Users as At}from"ckeditor5-premium-features";import{uid as V}from"ckeditor5";function B(){let t=["Bo","Jo","Moe","Mex","Tex","Hex","Brick","Em","Plate","Zee","DJ","CJ","AJ"],o=["King","Egli","Zwart","Principe","Siddiqui","Ehlers","Coltrane","Grimes","Cavallaro","Croce","Haddox","Weatherspoon","Gilpatrick","Funderburk","Mustard","Enterline","Redden","Hayford","Hevey","Dey","Demaio","Chenard","Whalley","Light","Kleist","Huntsman","Drovin","Duenes","Weintraub","Mcbeath","Harden","Streicher","Nadel","Philbrick","Ramm","Byrge","Broce","Olivera","Hamm","Tweedie","Hershman","Hertzler","Fielding","Dao","Constante","Berens","Finks","Corvin","Lemmons","Cuenca"],i=V(),e=t[Math.floor(Math.random()*t.length)],r=o[Math.floor(Math.random()*o.length)];return{name:e+" "+r,id:i}}function _(t,o=B()){return`${t}?`+Object.keys(o).filter(e=>o[e]).map(e=>`user.${e}=${o[e]}`).join("&")}function P(t){t.plugins.has("AIErrorSink")&&t.plugins.get("AIErrorSink").on("error",(o,{error:i,component:e,code:r,type:a,severity:l,context:d})=>{typeof window.Sentry>"u"||a==="user"||a==="network"||window.Sentry.captureException(i,{tags:{component:e,errorCode:r,errorType:a},level:l==="warning"?"warning":"error",extra:d})})}function F(t){t.commands.get("aiQuickAction")&&t.commands.get("aiQuickAction").on("execute",(i,e)=>{e[0].type==="CHAT"&&(t.commands.get("toggleAi").value||t.execute("toggleAi"))},{priority:"high"})}function D(t,o,{signal:i,edges:e}={}){let r,a=null,l=e!=null&&e.includes("leading"),d=e==null||e.includes("trailing"),c=()=>{a!==null&&(t.apply(r,a),r=void 0,a=null)},m=()=>{d&&c(),g()},s=null,u=()=>{s!=null&&clearTimeout(s),s=setTimeout(()=>{s=null,m()},o)},p=()=>{s!==null&&(clearTimeout(s),s=null)},g=()=>{p(),r=void 0,a=null},f=()=>{c()},b=function(...H){if(i?.aborted)return;r=this,a=H;let z=s==null;u(),l&&z&&c()};return b.schedule=u,b.cancel=g,b.flush=f,i?.addEventListener("abort",g,{once:!0}),b}function x(t,o=0,i={}){typeof i!="object"&&(i={});let{leading:e=!1,trailing:r=!0,maxWait:a}=i,l=Array(2);e&&(l[0]="leading"),r&&(l[1]="trailing");let d,c=null,m=D(function(...p){d=t.apply(this,p),c=null},o,{edges:l}),s=function(...p){return a!=null&&(c===null&&(c=Date.now()),Date.now()-c>=a)?((e||r)&&(d=t.apply(this,p)),c=Date.now(),m.cancel(),m.schedule(),d):(m.apply(this,p),d)},u=()=>(m.flush(),d);return s.cancel=m.cancel,s.flush=u,s}function T(t){t.on("ready",()=>{let o=t.plugins.get("AnnotationsUIs"),i=t.commands.get("toggleFullscreen"),e=document.querySelector(".editing-area-scroll-wrapper"),r=parseFloat(window.getComputedStyle(document.documentElement).getPropertyValue("--ck-demo-sidebar-wide-min-width"));if(isNaN(parseFloat(r))){console.error("--ck-demo-sidebar-wide-min-width is required by DynamicAnnotationsModeIntegration");return}let a=new Map([[document.querySelector(".editing-area-scroll-wrapper .ck.editor-content"),["margin-left","margin-right","border-left-width","border-right-width","scrollWidth"]],[document.querySelector(".editing-area-scroll-wrapper .editor-content-wrapper"),["padding-left","padding-right"]]]),l=x(()=>{if(!(i&&i.value))if(e.scrollWidth>e.clientWidth)m("narrowSidebar");else{let s=0;a.forEach((u,p)=>{let g=getComputedStyle(p);for(let f of u)f==="scrollWidth"?s+=p.scrollWidth:s+=parseFloat(g.getPropertyValue(f))||0}),s+r<e.clientWidth&&m("wideSidebar")}},10),d=new ResizeObserver(l);d.observe(e),d.observe(document.querySelector(".editor-content-wrapper")),i&&i.on("execute",()=>{i.value||l()}),l();let c="wideSidebar";function m(s){c!==s&&(o.switchTo(s),c=s)}})}function S(){let t=document.querySelectorAll(".live-snippet"),o=[];return t.forEach(i=>{let e=i.querySelector(".live-snippet__container");if(!e)return;let r=document.createElement("div");r.classList.add("live-snippet__loader"),r.innerHTML=`<svg class="spinner" viewBox="25 25 50 50">
				<circle class="path" cx="50" cy="50" r="20" fill="none" stroke-width="2" stroke-miterlimit="10"></circle>
			</svg>`,i.prepend(r),o.push({container:e,spinner:r,markDemoAsLoaded(){r.classList.add("fadeout"),e.classList.add("loaded")}})}),o}import{uid as Q}from"ckeditor5";function A(t){let o=location.search.match(new RegExp(`${t}=([^&]+)`)),i=o?decodeURIComponent(o[1]):null;if(!i){i=Q();let e=new URL(window.location.href);e.searchParams.set(t,i),window.history.replaceState({},document.title,e.toString())}return i}var Et=A("channelId"),h=A("userId"),E={name:Bt(),id:h,role:"writer"},L=class extends Oe{static get requires(){return[At,pt]}init(){let o=this.editor.plugins.get("Users"),i=this.editor.plugins.get("CommentsRepository");o.addUser(E),o.defineMe(E.id),i.adapter={addComment:()=>Promise.resolve(),updateComment:()=>Promise.resolve(),removeComment:()=>Promise.resolve(),getCommentThread:({threadId:e})=>{let r={"thread-1":{threadId:"thread-1",comments:[{commentId:"comment-1",authorId:h,content:"<p>What are some typical examples of Tier 2 cases?</p>",createdAt:new Date}]},"thread-2":{threadId:"thread-2",comments:[{commentId:"comment-1",authorId:h,content:"<p>Could we add one sentence explaining what qualifies as \u201Chigh-impact\u201D?</p>",createdAt:new Date}]},"thread-3":{threadId:"thread-3",comments:[{commentId:"comment-1",authorId:h,content:"<p>Can we add percentages for each category?</p>",createdAt:new Date}]},"thread-4":{threadId:"thread-4",comments:[{commentId:"comment-1",authorId:h,content:"<p>Can we add a short explanation here?</p>",createdAt:new Date}]}};return Promise.resolve(r[e])},addCommentThread:()=>Promise.resolve({comments:[]}),updateCommentThread:()=>Promise.resolve(),resolveCommentThread:()=>Promise.resolve({resolvedAt:new Date,resolvedBy:o.me.id}),reopenCommentThread:()=>Promise.resolve(),removeCommentThread:()=>Promise.resolve()}}},Lt=`<h1>Customer Support Metrics Report</h1>
