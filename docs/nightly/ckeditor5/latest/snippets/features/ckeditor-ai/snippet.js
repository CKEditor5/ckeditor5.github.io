var $=Object.create;var F=Object.defineProperty;var Z=Object.getOwnPropertyDescriptor;var X=Object.getOwnPropertyNames;var Y=Object.getPrototypeOf,ee=Object.prototype.hasOwnProperty;var te=(e,t)=>()=>(e&&(t=e(e=0)),t);var v=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports);var oe=(e,t,i,o)=>{if(t&&typeof t=="object"||typeof t=="function")for(let n of X(t))!ee.call(e,n)&&n!==i&&F(e,n,{get:()=>t[n],enumerable:!(o=Z(t,n))||o.enumerable});return e};var re=(e,t,i)=>(i=e!=null?$(Y(e)):{},oe(t||!e||!e.__esModule?F(i,"default",{value:e,enumerable:!0}):i,e));var r=te(()=>{});var O=v(S=>{"use strict";r();Object.defineProperty(S,Symbol.toStringTag,{value:"Module"});function de(e,t,{signal:i,edges:o}={}){let n,l=null,d=o!=null&&o.includes("leading"),u=o==null||o.includes("trailing"),c=()=>{l!==null&&(e.apply(n,l),n=void 0,l=null)},m=()=>{u&&c(),h()},s=null,g=()=>{s!=null&&clearTimeout(s),s=setTimeout(()=>{s=null,m()},t)},p=()=>{s!==null&&(clearTimeout(s),s=null)},h=()=>{p(),n=void 0,l=null},b=()=>{c()},y=function(...J){if(i?.aborted)return;n=this,l=J;let G=s==null;g(),d&&G&&c()};return y.schedule=g,y.cancel=h,y.flush=b,i?.addEventListener("abort",h,{once:!0}),y}S.debounce=de});var q=v(A=>{"use strict";r();Object.defineProperty(A,Symbol.toStringTag,{value:"Module"});var ce=O();function me(e,t=0,i={}){typeof i!="object"&&(i={});let{leading:o=!1,trailing:n=!0,maxWait:l}=i,d=Array(2);o&&(d[0]="leading"),n&&(d[1]="trailing");let u,c=null,m=ce.debounce(function(...p){u=e.apply(this,p),c=null},t,{edges:d}),s=function(...p){return l!=null&&(c===null&&(c=Date.now()),Date.now()-c>=l)?(u=e.apply(this,p),c=Date.now(),m.cancel(),m.schedule(),u):(m.apply(this,p),u)},g=()=>(m.flush(),u);return s.cancel=m.cancel,s.flush=g,s}A.debounce=me});var z=v((Va,H)=>{r();H.exports=q().debounce});r();r();import{Alignment as pe,Autoformat as K,AutoImage as ge,AutoLink as he,Autosave as fe,BalloonToolbar as be,BlockQuote as ye,Bold as N,Bookmark as we,CKBox as ke,CKBoxImageEdit as ve,CloudServices as Ce,Code as Ie,DecoupledEditor as Te,Emoji as xe,Essentials as Se,FindAndReplace as Ae,FontBackgroundColor as Ee,FontColor as Le,FontFamily as Be,FontSize as Pe,Fullscreen as _e,Heading as Fe,HorizontalLine as Me,ImageBlock as De,ImageCaption as Ue,ImageEditing as Re,ImageInline as Oe,ImageInsert as qe,ImageInsertViaUrl as He,ImageResize as ze,ImageStyle as We,ImageTextAlternative as Ke,ImageToolbar as Ne,ImageUpload as Ve,ImageUtils as Qe,Indent as je,IndentBlock as Je,Italic as V,Link as Ge,LinkImage as $e,List as Ze,ListProperties as Xe,Mention as Ye,Paragraph as et,PasteFromOffice as tt,PictureEditing as ot,Plugin as rt,RemoveFormat as it,SpecialCharacters as nt,SpecialCharactersArrows as at,SpecialCharactersCurrency as st,SpecialCharactersEssentials as lt,SpecialCharactersLatin as dt,SpecialCharactersMathematical as ct,SpecialCharactersText as mt,Strikethrough as ut,Subscript as pt,Superscript as gt,Table as ht,TableCaption as ft,TableCellProperties as bt,TableColumnResize as yt,TableProperties as wt,TableToolbar as kt,TextTransformation as vt,TodoList as Ct,Underline as It}from"ckeditor5";r();r();var ie="https://33333.cke-cs.com/token/dev/ijrDsqFix838Gh3wGO3F77FSW94BwcLXprJ4APSp3XQ26xsUHTi0jcb1hoBt",ne="https://33333.cke-cs.com/easyimage/upload/",ae="33333.cke-cs.com/ws",w={tokenUrl:ie,uploadUrl:ne,webSocketUrl:ae};r();var C="https://api.ckbox.io/token/demo";r();import{Plugin as lo}from"@ckeditor/ckeditor5-core";import{Essentials as mo}from"@ckeditor/ckeditor5-essentials";import{Autoformat as po}from"@ckeditor/ckeditor5-autoformat";import{BlockQuote as ho}from"@ckeditor/ckeditor5-block-quote";import{Bold as bo,Italic as yo}from"@ckeditor/ckeditor5-basic-styles";import{Heading as ko}from"@ckeditor/ckeditor5-heading";import{Image as Co,ImageCaption as Io,ImageStyle as To,ImageToolbar as xo}from"@ckeditor/ckeditor5-image";import{Indent as Ao}from"@ckeditor/ckeditor5-indent";import{Link as Lo}from"@ckeditor/ckeditor5-link";import{List as Po}from"@ckeditor/ckeditor5-list";import{MediaEmbed as Fo}from"@ckeditor/ckeditor5-media-embed";import{Paragraph as Do}from"@ckeditor/ckeditor5-paragraph";import{Table as Ro,TableToolbar as Oo}from"@ckeditor/ckeditor5-table";r();function I({id:e,target:t,text:i,editor:o,tippyOptions:n}){if(!t){console.warn("[attachTourBalloon] The target DOM node for the feature tour balloon does not exist.",{text:i});return}if(!t.offsetParent){console.warn("[attachTourBalloon] The target DOM node is invisible and the balloon could not be attached.",{target:t,text:i});return}let l=window.umberto.Tooltip.create({id:e,text:i,trigger:t,mode:"click",variant:"dark",icon:"bulb",disableOnMobile:!1,showCloseButton:!0,showAfterMount:!0,hideOnOutsideClick:!1,destroyOnHide:!0,...n?.placement&&{position:n.placement}});for(let d of o.editing.view.document.roots)d.once("change:isFocused",(u,c,m)=>{m&&l.destroy()});return l}function T(e,t){let i=e.items,o;return typeof t=="function"?o=i.find(t):o=i.get(t),o?o.element:void 0}function x(){let e=document.documentElement;return parseInt(window.getComputedStyle(e).getPropertyValue("--ck-snippet-viewport-top-offset"))}function k(e){return document.querySelector(`link[href*="${e}/snippet.css"][data-cke]`)?.href||""}r();import{BalloonEditor as No,Essentials as Vo,Autoformat as Qo,BlockToolbar as jo,Bold as Jo,Italic as Go,BlockQuote as $o,CKBox as Zo,Heading as Xo,Image as Yo,ImageCaption as er,ImageStyle as tr,ImageToolbar as or,ImageUpload as rr,PictureEditing as ir,Indent as nr,IndentBlock as ar,Link as sr,List as lr,MediaEmbed as dr,Paragraph as cr,PasteFromOffice as mr,Table as ur,TableToolbar as pr,TextTransformation as gr,CloudServices as hr}from"ckeditor5";r();import{BalloonEditor as wr,Essentials as kr,Autoformat as vr,Bold as Cr,Italic as Ir,BlockQuote as Tr,CKBox as xr,Heading as Sr,Image as Ar,ImageCaption as Er,ImageStyle as Lr,ImageToolbar as Br,ImageUpload as Pr,PictureEditing as _r,Indent as Fr,IndentBlock as Mr,Link as Dr,List as Ur,MediaEmbed as Rr,Paragraph as Or,PasteFromOffice as qr,Table as Hr,TableToolbar as zr,TextTransformation as Wr,CloudServices as Kr}from"ckeditor5";r();import{ClassicEditor as jr,Essentials as Jr,Autoformat as Gr,Bold as $r,Italic as Zr,BlockQuote as Xr,CKBox as Yr,Heading as ei,Image as ti,ImageCaption as oi,ImageStyle as ri,ImageToolbar as ii,ImageUpload as ni,PictureEditing as ai,Indent as si,IndentBlock as li,Link as di,List as ci,MediaEmbed as mi,Paragraph as ui,PasteFromOffice as pi,Table as gi,TableToolbar as hi,TextTransformation as fi,CloudServices as bi,AutoImage as yi,ImageInsert as wi,Bookmark as ki}from"ckeditor5";r();import{DecoupledEditor as Ti,Essentials as xi,Alignment as Si,FontSize as Ai,FontFamily as Ei,FontColor as Li,FontBackgroundColor as Bi,Autoformat as Pi,Bold as _i,Italic as Fi,Strikethrough as Mi,Underline as Di,BlockQuote as Ui,CKBox as Ri,Heading as Oi,Image as qi,ImageCaption as Hi,ImageResize as zi,ImageStyle as Wi,ImageToolbar as Ki,ImageUpload as Ni,PictureEditing as Vi,Indent as Qi,IndentBlock as ji,Link as Ji,List as Gi,ListProperties as $i,MediaEmbed as Zi,Paragraph as Xi,PasteFromOffice as Yi,Table as en,TableToolbar as tn,TextTransformation as on,CloudServices as rn}from"ckeditor5";r();import{InlineEditor as ln,Essentials as dn,Autoformat as cn,Bold as mn,Italic as un,BlockQuote as pn,CKBox as gn,Heading as hn,Image as fn,ImageCaption as bn,ImageStyle as yn,ImageToolbar as wn,ImageUpload as kn,PictureEditing as vn,Indent as Cn,IndentBlock as In,Link as Tn,List as xn,MediaEmbed as Sn,Paragraph as An,PasteFromOffice as En,Table as Ln,TableToolbar as Bn,TextTransformation as Pn,CloudServices as _n}from"ckeditor5";r();import{MultiRootEditor as Un,Essentials as Rn,Autoformat as On,Bold as qn,Italic as Hn,BlockQuote as zn,CKBox as Wn,Heading as Kn,Image as Nn,ImageCaption as Vn,ImageStyle as Qn,ImageToolbar as jn,ImageUpload as Jn,PictureEditing as Gn,Indent as $n,IndentBlock as Zn,Link as Xn,List as Yn,MediaEmbed as ea,Paragraph as ta,PasteFromOffice as oa,Table as ra,TableToolbar as ia,TextTransformation as na,CloudServices as aa}from"ckeditor5";import{AIChat as Tt,AIEditorIntegration as xt,AIQuickActions as St,AIReviewMode as At,AITranslate as Et,CaseChange as Lt,Comments as Bt,CommentsRepository as Pt,ExportPdf as _t,ExportWord as Ft,Footnotes as Mt,FormatPainter as Dt,ImportWord as Ut,LineHeight as Rt,MergeFields as Ot,MultiLevelList as qt,PasteFromOfficeEnhanced as Ht,SlashCommand as zt,TableOfContents as Wt,Template as Kt,TrackChanges as Nt,TrackChangesData as Vt,TrackChangesPreview as Qt,Users as jt}from"ckeditor5-premium-features";r();r();import{uid as se}from"ckeditor5";function M(){let e=["Bo","Jo","Moe","Mex","Tex","Hex","Brick","Em","Plate","Zee","DJ","CJ","AJ"],t=["King","Egli","Zwart","Principe","Siddiqui","Ehlers","Coltrane","Grimes","Cavallaro","Croce","Haddox","Weatherspoon","Gilpatrick","Funderburk","Mustard","Enterline","Redden","Hayford","Hevey","Dey","Demaio","Chenard","Whalley","Light","Kleist","Huntsman","Drovin","Duenes","Weintraub","Mcbeath","Harden","Streicher","Nadel","Philbrick","Ramm","Byrge","Broce","Olivera","Hamm","Tweedie","Hershman","Hertzler","Fielding","Dao","Constante","Berens","Finks","Corvin","Lemmons","Cuenca"],i=se(),o=e[Math.floor(Math.random()*e.length)],n=t[Math.floor(Math.random()*t.length)];return{name:o+" "+n,id:i}}function D(e,t=M()){return`${e}?`+Object.keys(t).filter(o=>t[o]).map(o=>`user.${o}=${t[o]}`).join("&")}r();import{AICoreError as le}from"ckeditor5-premium-features";function U(e){e.plugins.has("AIErrorSink")&&e.plugins.get("AIErrorSink").on("error",(t,{error:i,component:o,context:n})=>{typeof window.Sentry>"u"||i instanceof le&&(i.type==="user"||i.type==="network")||window.Sentry.captureException(i,{tags:{component:o},extra:n})})}r();function R(e){e.commands.get("aiQuickAction")&&e.commands.get("aiQuickAction").on("execute",(i,o)=>{o[0].type==="CHAT"&&(e.commands.get("toggleAi").value||e.execute("toggleAi"))},{priority:"high"})}r();var W=re(z(),1);function E(e){e.on("ready",()=>{let t=e.plugins.get("AnnotationsUIs"),i=e.commands.get("toggleFullscreen"),o=document.querySelector(".editing-area-scroll-wrapper"),n=parseFloat(window.getComputedStyle(document.documentElement).getPropertyValue("--ck-demo-sidebar-wide-min-width"));if(isNaN(parseFloat(n))){console.error("--ck-demo-sidebar-wide-min-width is required by DynamicAnnotationsModeIntegration");return}let l=new Map([[document.querySelector(".editing-area-scroll-wrapper .ck.editor-content"),["margin-left","margin-right","border-left-width","border-right-width","scrollWidth"]],[document.querySelector(".editing-area-scroll-wrapper .editor-content-wrapper"),["padding-left","padding-right"]]]),d=(0,W.default)(()=>{if(!(i&&i.value))if(o.scrollWidth>o.clientWidth)m("narrowSidebar");else{let s=0;l.forEach((g,p)=>{let h=getComputedStyle(p);for(let b of g)b==="scrollWidth"?s+=p.scrollWidth:s+=parseFloat(h.getPropertyValue(b))||0}),s+n<o.clientWidth&&m("wideSidebar")}},10),u=new ResizeObserver(d);u.observe(o),u.observe(document.querySelector(".editor-content-wrapper")),i&&i.on("execute",()=>{i.value||d()}),d();let c="wideSidebar";function m(s){c!==s&&(t.switchTo(s),c=s)}})}r();function L(){let e=document.querySelectorAll(".live-snippet"),t=[];return e.forEach(i=>{let o=i.querySelector(".live-snippet__container");if(!o)return;let n=document.createElement("div");n.classList.add("live-snippet__loader"),n.innerHTML=`<svg class="spinner" viewBox="25 25 50 50">
				<circle class="path" cx="50" cy="50" r="20" fill="none" stroke-width="2" stroke-miterlimit="10"></circle>
			</svg>`,i.prepend(n),t.push({container:o,spinner:n,markDemoAsLoaded(){n.classList.add("fadeout"),o.classList.add("loaded")}})}),t}r();import{uid as ue}from"ckeditor5";function B(e){let t=location.search.match(new RegExp(`${e}=([^&]+)`)),i=t?decodeURIComponent(t[1]):null;if(!i){i=ue();let o=new URL(window.location.href);o.searchParams.set(e,i),window.history.replaceState({},document.title,o.toString())}return i}var Jt=B("channelId"),f=B("userId"),P={name:$t(),id:f,role:"writer"},_=class extends rt{static get requires(){return[jt,Pt]}init(){let t=this.editor.plugins.get("Users"),i=this.editor.plugins.get("CommentsRepository");t.addUser(P),t.defineMe(P.id),i.adapter={addComment:()=>Promise.resolve(),updateComment:()=>Promise.resolve(),removeComment:()=>Promise.resolve(),getCommentThread:({threadId:o})=>{let n={"thread-1":{threadId:"thread-1",comments:[{commentId:"comment-1",authorId:f,content:"<p>What are some typical examples of Tier 2 cases?</p>",createdAt:new Date}]},"thread-2":{threadId:"thread-2",comments:[{commentId:"comment-1",authorId:f,content:"<p>Could we add one sentence explaining what qualifies as \u201Chigh-impact\u201D?</p>",createdAt:new Date}]},"thread-3":{threadId:"thread-3",comments:[{commentId:"comment-1",authorId:f,content:"<p>Can we add percentages for each category?</p>",createdAt:new Date}]},"thread-4":{threadId:"thread-4",comments:[{commentId:"comment-1",authorId:f,content:"<p>Can we add a short explanation here?</p>",createdAt:new Date}]}};return Promise.resolve(n[o])},addCommentThread:()=>Promise.resolve({comments:[]}),updateCommentThread:()=>Promise.resolve(),resolveCommentThread:()=>Promise.resolve({resolvedAt:new Date,resolvedBy:t.me.id}),reopenCommentThread:()=>Promise.resolve(),removeCommentThread:()=>Promise.resolve()}}},Gt=`<h1>Customer Support Metrics Report</h1>
