var G=Object.create;var F=Object.defineProperty;var $=Object.getOwnPropertyDescriptor;var Z=Object.getOwnPropertyNames;var X=Object.getPrototypeOf,Y=Object.prototype.hasOwnProperty;var ee=(e,t)=>()=>(e&&(t=e(e=0)),t);var v=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports);var te=(e,t,r,o)=>{if(t&&typeof t=="object"||typeof t=="function")for(let n of Z(t))!Y.call(e,n)&&n!==r&&F(e,n,{get:()=>t[n],enumerable:!(o=$(t,n))||o.enumerable});return e};var oe=(e,t,r)=>(r=e!=null?G(X(e)):{},te(t||!e||!e.__esModule?F(r,"default",{value:e,enumerable:!0}):r,e));var i=ee(()=>{});var R=v(S=>{"use strict";i();Object.defineProperty(S,Symbol.toStringTag,{value:"Module"});function se(e,t,{signal:r,edges:o}={}){let n,l=null,d=o!=null&&o.includes("leading"),u=o==null||o.includes("trailing"),c=()=>{l!==null&&(e.apply(n,l),n=void 0,l=null)},m=()=>{u&&c(),h()},s=null,g=()=>{s!=null&&clearTimeout(s),s=setTimeout(()=>{s=null,m()},t)},p=()=>{s!==null&&(clearTimeout(s),s=null)},h=()=>{p(),n=void 0,l=null},b=()=>{c()},y=function(...j){if(r?.aborted)return;n=this,l=j;let J=s==null;g(),d&&J&&c()};return y.schedule=g,y.cancel=h,y.flush=b,r?.addEventListener("abort",h,{once:!0}),y}S.debounce=se});var O=v(A=>{"use strict";i();Object.defineProperty(A,Symbol.toStringTag,{value:"Module"});var le=R();function de(e,t=0,r={}){typeof r!="object"&&(r={});let{leading:o=!1,trailing:n=!0,maxWait:l}=r,d=Array(2);o&&(d[0]="leading"),n&&(d[1]="trailing");let u,c=null,m=le.debounce(function(...p){u=e.apply(this,p),c=null},t,{edges:d}),s=function(...p){return l!=null&&(c===null&&(c=Date.now()),Date.now()-c>=l)?(u=e.apply(this,p),c=Date.now(),m.cancel(),m.schedule(),u):(m.apply(this,p),u)},g=()=>(m.flush(),u);return s.cancel=m.cancel,s.flush=g,s}A.debounce=de});var H=v((Ha,q)=>{i();q.exports=O().debounce});i();i();import{Alignment as me,Autoformat as W,AutoImage as ue,AutoLink as pe,Autosave as ge,BalloonToolbar as he,BlockQuote as fe,Bold as K,Bookmark as be,CKBox as ye,CKBoxImageEdit as we,CloudServices as ke,Code as ve,DecoupledEditor as Ce,Emoji as Ie,Essentials as Te,FindAndReplace as xe,FontBackgroundColor as Se,FontColor as Ae,FontFamily as Ee,FontSize as Le,Fullscreen as Be,Heading as Pe,HorizontalLine as _e,ImageBlock as Fe,ImageCaption as Me,ImageEditing as De,ImageInline as Ue,ImageInsert as Re,ImageInsertViaUrl as Oe,ImageResize as qe,ImageStyle as He,ImageTextAlternative as ze,ImageToolbar as We,ImageUpload as Ke,ImageUtils as Ne,Indent as Ve,IndentBlock as Qe,Italic as N,Link as je,LinkImage as Je,List as Ge,ListProperties as $e,Mention as Ze,Paragraph as Xe,PasteFromOffice as Ye,PictureEditing as et,Plugin as tt,RemoveFormat as ot,SpecialCharacters as it,SpecialCharactersArrows as rt,SpecialCharactersCurrency as nt,SpecialCharactersEssentials as at,SpecialCharactersLatin as st,SpecialCharactersMathematical as lt,SpecialCharactersText as dt,Strikethrough as ct,Subscript as mt,Superscript as ut,Table as pt,TableCaption as gt,TableCellProperties as ht,TableColumnResize as ft,TableProperties as bt,TableToolbar as yt,TextTransformation as wt,TodoList as kt,Underline as vt}from"ckeditor5";i();i();var ie="https://33333.cke-cs.com/token/dev/ijrDsqFix838Gh3wGO3F77FSW94BwcLXprJ4APSp3XQ26xsUHTi0jcb1hoBt",re="https://33333.cke-cs.com/easyimage/upload/",ne="33333.cke-cs.com/ws",w={tokenUrl:ie,uploadUrl:re,webSocketUrl:ne};i();var C="https://api.ckbox.io/token/demo";i();import{Plugin as ao}from"@ckeditor/ckeditor5-core";import{Essentials as lo}from"@ckeditor/ckeditor5-essentials";import{Autoformat as mo}from"@ckeditor/ckeditor5-autoformat";import{BlockQuote as po}from"@ckeditor/ckeditor5-block-quote";import{Bold as ho,Italic as fo}from"@ckeditor/ckeditor5-basic-styles";import{Heading as yo}from"@ckeditor/ckeditor5-heading";import{Image as ko,ImageCaption as vo,ImageStyle as Co,ImageToolbar as Io}from"@ckeditor/ckeditor5-image";import{Indent as xo}from"@ckeditor/ckeditor5-indent";import{Link as Ao}from"@ckeditor/ckeditor5-link";import{List as Lo}from"@ckeditor/ckeditor5-list";import{MediaEmbed as Po}from"@ckeditor/ckeditor5-media-embed";import{Paragraph as Fo}from"@ckeditor/ckeditor5-paragraph";import{Table as Do,TableToolbar as Uo}from"@ckeditor/ckeditor5-table";i();function I({id:e,target:t,text:r,editor:o,tippyOptions:n}){if(!t){console.warn("[attachTourBalloon] The target DOM node for the feature tour balloon does not exist.",{text:r});return}if(!t.offsetParent){console.warn("[attachTourBalloon] The target DOM node is invisible and the balloon could not be attached.",{target:t,text:r});return}let l=window.umberto.Tooltip.create({id:e,text:r,trigger:t,mode:"click",variant:"dark",icon:"bulb",disableOnMobile:!1,showCloseButton:!0,showAfterMount:!0,hideOnOutsideClick:!1,destroyOnHide:!0,...n?.placement&&{position:n.placement}});for(let d of o.editing.view.document.roots)d.once("change:isFocused",(u,c,m)=>{m&&l.destroy()});return l}function T(e,t){let r=e.items,o;return typeof t=="function"?o=r.find(t):o=r.get(t),o?o.element:void 0}function x(){let e=document.documentElement;return parseInt(window.getComputedStyle(e).getPropertyValue("--ck-snippet-viewport-top-offset"))}function k(e){return document.querySelector(`link[href*="${e}/snippet.css"][data-cke]`)?.href||""}i();import{BalloonEditor as Wo,Essentials as Ko,Autoformat as No,BlockToolbar as Vo,Bold as Qo,Italic as jo,BlockQuote as Jo,CKBox as Go,Heading as $o,Image as Zo,ImageCaption as Xo,ImageStyle as Yo,ImageToolbar as ei,ImageUpload as ti,PictureEditing as oi,Indent as ii,IndentBlock as ri,Link as ni,List as ai,MediaEmbed as si,Paragraph as li,PasteFromOffice as di,Table as ci,TableToolbar as mi,TextTransformation as ui,CloudServices as pi}from"ckeditor5";i();import{BalloonEditor as bi,Essentials as yi,Autoformat as wi,Bold as ki,Italic as vi,BlockQuote as Ci,CKBox as Ii,Heading as Ti,Image as xi,ImageCaption as Si,ImageStyle as Ai,ImageToolbar as Ei,ImageUpload as Li,PictureEditing as Bi,Indent as Pi,IndentBlock as _i,Link as Fi,List as Mi,MediaEmbed as Di,Paragraph as Ui,PasteFromOffice as Ri,Table as Oi,TableToolbar as qi,TextTransformation as Hi,CloudServices as zi}from"ckeditor5";i();import{ClassicEditor as Vi,Essentials as Qi,Autoformat as ji,Bold as Ji,Italic as Gi,BlockQuote as $i,CKBox as Zi,Heading as Xi,Image as Yi,ImageCaption as er,ImageStyle as tr,ImageToolbar as or,ImageUpload as ir,PictureEditing as rr,Indent as nr,IndentBlock as ar,Link as sr,List as lr,MediaEmbed as dr,Paragraph as cr,PasteFromOffice as mr,Table as ur,TableToolbar as pr,TextTransformation as gr,CloudServices as hr,AutoImage as fr,ImageInsert as br,Bookmark as yr}from"ckeditor5";i();import{DecoupledEditor as Cr,Essentials as Ir,Alignment as Tr,FontSize as xr,FontFamily as Sr,FontColor as Ar,FontBackgroundColor as Er,Autoformat as Lr,Bold as Br,Italic as Pr,Strikethrough as _r,Underline as Fr,BlockQuote as Mr,CKBox as Dr,Heading as Ur,Image as Rr,ImageCaption as Or,ImageResize as qr,ImageStyle as Hr,ImageToolbar as zr,ImageUpload as Wr,PictureEditing as Kr,Indent as Nr,IndentBlock as Vr,Link as Qr,List as jr,ListProperties as Jr,MediaEmbed as Gr,Paragraph as $r,PasteFromOffice as Zr,Table as Xr,TableToolbar as Yr,TextTransformation as en,CloudServices as tn}from"ckeditor5";i();import{InlineEditor as an,Essentials as sn,Autoformat as ln,Bold as dn,Italic as cn,BlockQuote as mn,CKBox as un,Heading as pn,Image as gn,ImageCaption as hn,ImageStyle as fn,ImageToolbar as bn,ImageUpload as yn,PictureEditing as wn,Indent as kn,IndentBlock as vn,Link as Cn,List as In,MediaEmbed as Tn,Paragraph as xn,PasteFromOffice as Sn,Table as An,TableToolbar as En,TextTransformation as Ln,CloudServices as Bn}from"ckeditor5";i();import{MultiRootEditor as Mn,Essentials as Dn,Autoformat as Un,Bold as Rn,Italic as On,BlockQuote as qn,CKBox as Hn,Heading as zn,Image as Wn,ImageCaption as Kn,ImageStyle as Nn,ImageToolbar as Vn,ImageUpload as Qn,PictureEditing as jn,Indent as Jn,IndentBlock as Gn,Link as $n,List as Zn,MediaEmbed as Xn,Paragraph as Yn,PasteFromOffice as ea,Table as ta,TableToolbar as oa,TextTransformation as ia,CloudServices as ra}from"ckeditor5";import{AIChat as Ct,AIEditorIntegration as It,AIQuickActions as Tt,AIReviewMode as xt,AITranslate as St,CaseChange as At,Comments as Et,CommentsRepository as Lt,ExportPdf as Bt,ExportWord as Pt,Footnotes as _t,FormatPainter as Ft,ImportWord as Mt,LineHeight as Dt,MergeFields as Ut,MultiLevelList as Rt,PasteFromOfficeEnhanced as Ot,SlashCommand as qt,TableOfContents as Ht,Template as zt,TrackChanges as Wt,TrackChangesData as Kt,TrackChangesPreview as Nt,Users as Vt}from"ckeditor5-premium-features";i();i();import{uid as ae}from"ckeditor5";function M(){let e=["Bo","Jo","Moe","Mex","Tex","Hex","Brick","Em","Plate","Zee","DJ","CJ","AJ"],t=["King","Egli","Zwart","Principe","Siddiqui","Ehlers","Coltrane","Grimes","Cavallaro","Croce","Haddox","Weatherspoon","Gilpatrick","Funderburk","Mustard","Enterline","Redden","Hayford","Hevey","Dey","Demaio","Chenard","Whalley","Light","Kleist","Huntsman","Drovin","Duenes","Weintraub","Mcbeath","Harden","Streicher","Nadel","Philbrick","Ramm","Byrge","Broce","Olivera","Hamm","Tweedie","Hershman","Hertzler","Fielding","Dao","Constante","Berens","Finks","Corvin","Lemmons","Cuenca"],r=ae(),o=e[Math.floor(Math.random()*e.length)],n=t[Math.floor(Math.random()*t.length)];return{name:o+" "+n,id:r}}function D(e,t=M()){return`${e}?`+Object.keys(t).filter(o=>t[o]).map(o=>`user.${o}=${t[o]}`).join("&")}i();function U(e){e.commands.get("aiQuickAction")&&e.commands.get("aiQuickAction").on("execute",(r,o)=>{o[0].type==="CHAT"&&(e.commands.get("toggleAi").value||e.execute("toggleAi"))},{priority:"high"})}i();var z=oe(H(),1);function E(e){e.on("ready",()=>{let t=e.plugins.get("AnnotationsUIs"),r=e.commands.get("toggleFullscreen"),o=document.querySelector(".editing-area-scroll-wrapper"),n=parseFloat(window.getComputedStyle(document.documentElement).getPropertyValue("--ck-demo-sidebar-wide-min-width"));if(isNaN(parseFloat(n))){console.error("--ck-demo-sidebar-wide-min-width is required by DynamicAnnotationsModeIntegration");return}let l=new Map([[document.querySelector(".editing-area-scroll-wrapper .ck.editor-content"),["margin-left","margin-right","border-left-width","border-right-width","scrollWidth"]],[document.querySelector(".editing-area-scroll-wrapper .editor-content-wrapper"),["padding-left","padding-right"]]]),d=(0,z.default)(()=>{if(!(r&&r.value))if(o.scrollWidth>o.clientWidth)m("narrowSidebar");else{let s=0;l.forEach((g,p)=>{let h=getComputedStyle(p);for(let b of g)b==="scrollWidth"?s+=p.scrollWidth:s+=parseFloat(h.getPropertyValue(b))||0}),s+n<o.clientWidth&&m("wideSidebar")}},10),u=new ResizeObserver(d);u.observe(o),u.observe(document.querySelector(".editor-content-wrapper")),r&&r.on("execute",()=>{r.value||d()}),d();let c="wideSidebar";function m(s){c!==s&&(t.switchTo(s),c=s)}})}i();function L(){let e=document.querySelectorAll(".live-snippet"),t=[];return e.forEach(r=>{let o=r.querySelector(".live-snippet__container");if(!o)return;let n=document.createElement("div");n.classList.add("live-snippet__loader"),n.innerHTML=`<svg class="spinner" viewBox="25 25 50 50">
				<circle class="path" cx="50" cy="50" r="20" fill="none" stroke-width="2" stroke-miterlimit="10"></circle>
			</svg>`,r.prepend(n),t.push({container:o,spinner:n,markDemoAsLoaded(){n.classList.add("fadeout"),o.classList.add("loaded")}})}),t}i();import{uid as ce}from"ckeditor5";function B(e){let t=location.search.match(new RegExp(`${e}=([^&]+)`)),r=t?decodeURIComponent(t[1]):null;if(!r){r=ce();let o=new URL(window.location.href);o.searchParams.set(e,r),window.history.replaceState({},document.title,o.toString())}return r}var Qt=B("channelId"),f=B("userId"),P={name:Jt(),id:f,role:"writer"},_=class extends tt{static get requires(){return[Vt,Lt]}init(){let t=this.editor.plugins.get("Users"),r=this.editor.plugins.get("CommentsRepository");t.addUser(P),t.defineMe(P.id),r.adapter={addComment:()=>Promise.resolve(),updateComment:()=>Promise.resolve(),removeComment:()=>Promise.resolve(),getCommentThread:({threadId:o})=>{let n={"thread-1":{threadId:"thread-1",comments:[{commentId:"comment-1",authorId:f,content:"<p>What are some typical examples of Tier 2 cases?</p>",createdAt:new Date}]},"thread-2":{threadId:"thread-2",comments:[{commentId:"comment-1",authorId:f,content:"<p>Could we add one sentence explaining what qualifies as \u201Chigh-impact\u201D?</p>",createdAt:new Date}]},"thread-3":{threadId:"thread-3",comments:[{commentId:"comment-1",authorId:f,content:"<p>Can we add percentages for each category?</p>",createdAt:new Date}]},"thread-4":{threadId:"thread-4",comments:[{commentId:"comment-1",authorId:f,content:"<p>Can we add a short explanation here?</p>",createdAt:new Date}]}};return Promise.resolve(n[o])},addCommentThread:()=>Promise.resolve({comments:[]}),updateCommentThread:()=>Promise.resolve(),resolveCommentThread:()=>Promise.resolve({resolvedAt:new Date,resolvedBy:t.me.id}),reopenCommentThread:()=>Promise.resolve(),removeCommentThread:()=>Promise.resolve()}}},jt=`<h1>Customer Support Metrics Report</h1>
