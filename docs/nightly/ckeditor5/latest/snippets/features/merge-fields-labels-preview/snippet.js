var k="https://33333.cke-cs.com/token/dev/ijrDsqFix838Gh3wGO3F77FSW94BwcLXprJ4APSp3XQ26xsUHTi0jcb1hoBt",T="https://33333.cke-cs.com/easyimage/upload/",w="33333.cke-cs.com/ws",d={tokenUrl:k,uploadUrl:T,webSocketUrl:w};var c="https://api.ckbox.io/token/demo";import{Plugin as Ye}from"@ckeditor/ckeditor5-core";import{Essentials as Ze}from"@ckeditor/ckeditor5-essentials";import{Autoformat as tt}from"@ckeditor/ckeditor5-autoformat";import{BlockQuote as at}from"@ckeditor/ckeditor5-block-quote";import{Bold as it,Italic as lt}from"@ckeditor/ckeditor5-basic-styles";import{Heading as nt}from"@ckeditor/ckeditor5-heading";import{Image as ct,ImageCaption as pt,ImageStyle as mt,ImageToolbar as gt}from"@ckeditor/ckeditor5-image";import{Indent as ut}from"@ckeditor/ckeditor5-indent";import{Link as ht}from"@ckeditor/ckeditor5-link";import{List as xt}from"@ckeditor/ckeditor5-list";import{MediaEmbed as Tt}from"@ckeditor/ckeditor5-media-embed";import{Paragraph as It}from"@ckeditor/ckeditor5-paragraph";import{Table as Et,TableToolbar as Ct}from"@ckeditor/ckeditor5-table";function p({target:e,text:t,editor:l,tippyOptions:a}){if(!e){console.warn("[attachTourBalloon] The target DOM node for the feature tour balloon does not exist.",{text:t});return}if(!e.offsetParent){console.warn("[attachTourBalloon] The target DOM node is invisible and the balloon could not be attached.",{target:e,text:t});return}let b=window.umberto.Tooltip.create({text:t,trigger:e,mode:"click",variant:"dark",icon:"bulb",disableOnMobile:!1,showCloseButton:!0,showAfterMount:!0,hideOnOutsideClick:!1,destroyOnHide:!0,...a?.placement&&{position:a.placement}});for(let y of l.editing.view.document.roots)y.once("change:isFocused",(Qe,Xe,x)=>{x&&b.destroy()});return b}function m(e,t){let l=e.items,a;return typeof t=="function"?a=l.find(t):a=l.get(t),a?a.element:void 0}function g(){let e=document.documentElement;return parseInt(window.getComputedStyle(e).getPropertyValue("--ck-snippet-viewport-top-offset"))}import{BalloonEditor as Ft,Essentials as At,CKFinderUploadAdapter as Bt,Autoformat as Rt,BlockToolbar as Ot,Bold as Nt,Italic as Mt,BlockQuote as Vt,CKBox as Ut,CKFinder as Kt,EasyImage as Gt,Heading as Ht,Image as Qt,ImageCaption as Xt,ImageStyle as Wt,ImageToolbar as qt,ImageUpload as zt,PictureEditing as jt,Indent as Jt,Link as Yt,List as $t,MediaEmbed as Zt,Paragraph as eo,PasteFromOffice as to,Table as oo,TableToolbar as ao,TextTransformation as ro,CloudServices as io}from"ckeditor5";import{BalloonEditor as co,Essentials as po,CKFinderUploadAdapter as mo,Autoformat as go,Bold as fo,Italic as uo,BlockQuote as bo,CKBox as ho,CKFinder as yo,EasyImage as xo,Heading as ko,Image as To,ImageCaption as wo,ImageStyle as Io,ImageToolbar as So,ImageUpload as Eo,PictureEditing as Co,Indent as vo,Link as _o,List as Lo,MediaEmbed as Po,Paragraph as Do,PasteFromOffice as Fo,Table as Ao,TableToolbar as Bo,TextTransformation as Ro,CloudServices as Oo}from"ckeditor5";import{ClassicEditor as I,Essentials as S,Autoformat as E,Bold as C,Italic as v,BlockQuote as _,CKBox as L,EasyImage as P,Heading as D,Image as F,ImageCaption as A,ImageStyle as B,ImageToolbar as R,ImageUpload as O,PictureEditing as N,Indent as M,Link as V,List as U,MediaEmbed as K,Paragraph as G,PasteFromOffice as H,Table as Q,TableToolbar as X,TextTransformation as W,CloudServices as q,AutoImage as z,ImageInsert as j,Bookmark as J}from"ckeditor5";var r=class extends I{static builtinPlugins=[S,E,C,v,_,q,P,D,F,A,B,R,O,L,M,V,U,K,G,H,N,Q,X,W,z,j,J];static defaultConfig={toolbar:{items:["undo","redo","|","heading","|","bold","italic","|","link","uploadImage","insertTable","blockQuote","mediaEmbed","|","bulletedList","numberedList","outdent","indent"]},image:{toolbar:["imageStyle:inline","imageStyle:block","imageStyle:wrapText","|","toggleImageCaption","imageTextAlternative"]},table:{contentToolbar:["tableColumn","tableRow","mergeTableCells"]},language:"en"}};import{DecoupledEditor as Ho,Essentials as Qo,Alignment as Xo,FontSize as Wo,FontFamily as qo,FontColor as zo,FontBackgroundColor as jo,Autoformat as Jo,Bold as Yo,Italic as $o,Strikethrough as Zo,Underline as ea,BlockQuote as ta,CKBox as oa,EasyImage as aa,Heading as ra,Image as ia,ImageCaption as la,ImageResize as sa,ImageStyle as na,ImageToolbar as da,ImageUpload as ca,PictureEditing as pa,Indent as ma,IndentBlock as ga,Link as fa,List as ua,ListProperties as ba,MediaEmbed as ha,Paragraph as ya,PasteFromOffice as xa,Table as ka,TableToolbar as Ta,TextTransformation as wa,CloudServices as Ia}from"ckeditor5";import{InlineEditor as va,Essentials as _a,CKFinderUploadAdapter as La,Autoformat as Pa,Bold as Da,Italic as Fa,BlockQuote as Aa,CKBox as Ba,CKFinder as Ra,EasyImage as Oa,Heading as Na,Image as Ma,ImageCaption as Va,ImageStyle as Ua,ImageToolbar as Ka,ImageUpload as Ga,PictureEditing as Ha,Indent as Qa,Link as Xa,List as Wa,MediaEmbed as qa,Paragraph as za,PasteFromOffice as ja,Table as Ja,TableToolbar as Ya,TextTransformation as $a,CloudServices as Za}from"ckeditor5";import{MultiRootEditor as ar,Essentials as rr,CKFinderUploadAdapter as ir,Autoformat as lr,Bold as sr,Italic as nr,BlockQuote as dr,CKBox as cr,CKFinder as pr,EasyImage as mr,Heading as gr,Image as fr,ImageCaption as ur,ImageStyle as br,ImageToolbar as hr,ImageUpload as yr,PictureEditing as xr,Indent as kr,Link as Tr,List as wr,MediaEmbed as Ir,Paragraph as Sr,PasteFromOffice as Er,Table as Cr,TableToolbar as vr,TextTransformation as _r,CloudServices as Lr}from"ckeditor5";import{Alignment as Y,Autoformat as $,Bold as Z,Italic as ee,Underline as te,BlockQuote as oe,CKBox as ae,CKBoxImageEdit as re,CloudServices as ie,Essentials as le,FontBackgroundColor as se,FontColor as ne,FontFamily as de,FontSize as ce,Heading as pe,Indent as me,IndentBlock as ge,PictureEditing as fe,Image as ue,ImageCaption as be,ImageInsert as he,ImageResize as ye,ImageStyle as xe,ImageToolbar as ke,ImageUpload as Te,Link as we,List as Ie,MediaEmbed as Se,PageBreak as Ee,Paragraph as Ce,PasteFromOffice as ve,SpecialCharacters as _e,SpecialCharactersEssentials as Le,Table as Pe,TableCellProperties as De,TableProperties as Fe,TableToolbar as Ae,TextTransformation as Be,CodeBlock as Re,Mention as Oe,Plugin as Zr}from"ckeditor5";import{SourceEditingEnhanced as Ne,ExportPdf as Me,ExportWord as Ve,ImportWord as Ue,MergeFields as Ke,Template as Ge}from"ckeditor5-premium-features";var s="19.25mm",n="16mm",i=class extends r{static builtinPlugins=[...r.builtinPlugins,Ke,Oe,Y,le,$,oe,Z,ae,re,Re,pe,fe,ue,be,xe,ke,me,ee,we,Ie,Ce,Pe,Ae,Me,Ve,Ue,ce,de,ne,se,ge,Te,he,ye,Se,Ee,ve,_e,Le,Ne,Fe,De,Be,te,ie,Ge];static defaultConfig={mergeFields:{prefix:"{{",suffix:"}}",previewHtmlValues:!0,sanitizeHtml:t=>({html:t,hasChanged:!1}),definitions:[{groupId:"guestInformation",groupLabel:"Guest information",definitions:[{id:"guestTitle",label:"Title",defaultValue:"Mr./Mrs."},{id:"guestName",label:"Name",defaultValue:"John"},{id:"guestLastName",label:"Last name",defaultValue:"Doe"},{id:"discount",label:"Guest discount",defaultValue:"0%"},{id:"hotelRoomPhoto",label:"Hotel room photo",type:"image",width:600,height:400,defaultValue:"https://ckeditor.com/assets/images/ckdemo/merge-fields/hotel-room2.jpg"}]},{groupId:"reservationInformation",groupLabel:"Reservation information",definitions:[{id:"reservationNumber",label:"Reservation number",defaultValue:"0000"},{id:"arrivalDate",label:"Arrival date",defaultValue:()=>new Date().toLocaleDateString()},{id:"numberOfNights",label:"Number of nights",defaultValue:"0"},{id:"numberOfGuests",label:"Number of guests",defaultValue:"0"},{id:"roomType",label:"Room type",defaultValue:"Single room"},{id:"complimentaryDuration",label:"Complimentary duration",defaultValue:"60 min"},{id:"reservationDetails",label:"Reservation details",defaultValue:`
...
`,oi=[{id:"78900",label:"David Lee",values:{guestTitle:"Mr.",guestName:"David",guestLastName:"Lee",hotelRoomPhoto:"https://ckeditor.com/assets/images/ckdemo/merge-fields/hotel-room2.jpg",reservationNumber:"Y2JKH5G1Z",arrivalDate:new Date(2024,7,22).toLocaleDateString(),numberOfGuests:"2",numberOfNights:"6",roomType:"Double Room",discount:"20%",complimentaryDuration:"15 min",feedbackSurvey:'<a href="https://ckeditor.com/docs/ckeditor5/latest/features/merge-fields.html">quick survey</a>',resortPhone:"555-232-2334-23",reservationDetails:`
				<p style="text-align:center;"><strong>Reservation Details</strong></p>
				<figure class="table">
					<table>
						<tbody>
