var T="https://33333.cke-cs.com/token/dev/ijrDsqFix838Gh3wGO3F77FSW94BwcLXprJ4APSp3XQ26xsUHTi0jcb1hoBt",w="https://33333.cke-cs.com/easyimage/upload/",I="33333.cke-cs.com/ws",d={tokenUrl:T,uploadUrl:w,webSocketUrl:I};var c="https://api.ckbox.io/token/demo";import{Plugin as Ye}from"@ckeditor/ckeditor5-core";import{Essentials as et}from"@ckeditor/ckeditor5-essentials";import{Autoformat as ot}from"@ckeditor/ckeditor5-autoformat";import{BlockQuote as it}from"@ckeditor/ckeditor5-block-quote";import{Bold as lt,Italic as st}from"@ckeditor/ckeditor5-basic-styles";import{Heading as dt}from"@ckeditor/ckeditor5-heading";import{Image as pt,ImageCaption as mt,ImageStyle as gt,ImageToolbar as ut}from"@ckeditor/ckeditor5-image";import{Indent as bt}from"@ckeditor/ckeditor5-indent";import{Link as yt}from"@ckeditor/ckeditor5-link";import{List as kt}from"@ckeditor/ckeditor5-list";import{MediaEmbed as wt}from"@ckeditor/ckeditor5-media-embed";import{Paragraph as St}from"@ckeditor/ckeditor5-paragraph";import{Table as Ct,TableToolbar as vt}from"@ckeditor/ckeditor5-table";function p({id:e,target:t,text:a,editor:i,tippyOptions:b}){if(!t){console.warn("[attachTourBalloon] The target DOM node for the feature tour balloon does not exist.",{text:a});return}if(!t.offsetParent){console.warn("[attachTourBalloon] The target DOM node is invisible and the balloon could not be attached.",{target:t,text:a});return}let h=window.umberto.Tooltip.create({id:e,text:a,trigger:t,mode:"click",variant:"dark",icon:"bulb",disableOnMobile:!1,showCloseButton:!0,showAfterMount:!0,hideOnOutsideClick:!1,destroyOnHide:!0,...b?.placement&&{position:b.placement}});for(let x of i.editing.view.document.roots)x.once("change:isFocused",(Qe,Xe,k)=>{k&&h.destroy()});return h}function m(e,t){let a=e.items,i;return typeof t=="function"?i=a.find(t):i=a.get(t),i?i.element:void 0}function g(){let e=document.documentElement;return parseInt(window.getComputedStyle(e).getPropertyValue("--ck-snippet-viewport-top-offset"))}import{BalloonEditor as Rt,Essentials as At,Autoformat as Ot,BlockToolbar as Ft,Bold as Nt,Italic as Mt,BlockQuote as Vt,CKBox as Ut,Heading as Gt,Image as Kt,ImageCaption as Ht,ImageStyle as qt,ImageToolbar as Qt,ImageUpload as Xt,PictureEditing as zt,Indent as Wt,IndentBlock as jt,Link as Jt,List as $t,MediaEmbed as Yt,Paragraph as Zt,PasteFromOffice as eo,Table as to,TableToolbar as oo,TextTransformation as ao,CloudServices as io}from"ckeditor5";import{BalloonEditor as no,Essentials as co,Autoformat as po,Bold as mo,Italic as go,BlockQuote as uo,CKBox as fo,Heading as bo,Image as ho,ImageCaption as yo,ImageStyle as xo,ImageToolbar as ko,ImageUpload as To,PictureEditing as wo,Indent as Io,IndentBlock as So,Link as Eo,List as Co,MediaEmbed as vo,Paragraph as Lo,PasteFromOffice as Po,Table as _o,TableToolbar as Do,TextTransformation as Bo,CloudServices as Ro}from"ckeditor5";import{ClassicEditor as S,Essentials as E,Autoformat as C,Bold as v,Italic as L,BlockQuote as P,CKBox as _,Heading as D,Image as B,ImageCaption as R,ImageStyle as A,ImageToolbar as O,ImageUpload as F,PictureEditing as N,Indent as M,IndentBlock as V,Link as U,List as G,MediaEmbed as K,Paragraph as H,PasteFromOffice as q,Table as Q,TableToolbar as X,TextTransformation as z,CloudServices as W,AutoImage as j,ImageInsert as J,Bookmark as $}from"ckeditor5";var r=class extends S{static builtinPlugins=[E,C,v,L,P,W,D,B,R,A,O,F,_,M,V,U,G,K,H,q,N,Q,X,z,j,J,$];static defaultConfig={toolbar:{items:["undo","redo","|","heading","|","bold","italic","|","link","uploadImage","insertTable","blockQuote","mediaEmbed","|","bulletedList","numberedList","outdent","indent"]},image:{toolbar:["imageStyle:inline","imageStyle:block","imageStyle:wrapText","|","toggleImageCaption","imageTextAlternative"]},table:{contentToolbar:["tableColumn","tableRow","mergeTableCells"]},list:{enableSkipLevelLists:!0},language:"en"}};import{DecoupledEditor as Uo,Essentials as Go,Alignment as Ko,FontSize as Ho,FontFamily as qo,FontColor as Qo,FontBackgroundColor as Xo,Autoformat as zo,Bold as Wo,Italic as jo,Strikethrough as Jo,Underline as $o,BlockQuote as Yo,CKBox as Zo,Heading as ea,Image as ta,ImageCaption as oa,ImageResize as aa,ImageStyle as ia,ImageToolbar as ra,ImageUpload as la,PictureEditing as sa,Indent as na,IndentBlock as da,Link as ca,List as pa,ListProperties as ma,MediaEmbed as ga,Paragraph as ua,PasteFromOffice as fa,Table as ba,TableToolbar as ha,TextTransformation as ya,CloudServices as xa}from"ckeditor5";import{InlineEditor as Ia,Essentials as Sa,Autoformat as Ea,Bold as Ca,Italic as va,BlockQuote as La,CKBox as Pa,Heading as _a,Image as Da,ImageCaption as Ba,ImageStyle as Ra,ImageToolbar as Aa,ImageUpload as Oa,PictureEditing as Fa,Indent as Na,IndentBlock as Ma,Link as Va,List as Ua,MediaEmbed as Ga,Paragraph as Ka,PasteFromOffice as Ha,Table as qa,TableToolbar as Qa,TextTransformation as Xa,CloudServices as za}from"ckeditor5";import{MultiRootEditor as $a,Essentials as Ya,Autoformat as Za,Bold as ei,Italic as ti,BlockQuote as oi,CKBox as ai,Heading as ii,Image as ri,ImageCaption as li,ImageStyle as si,ImageToolbar as ni,ImageUpload as di,PictureEditing as ci,Indent as pi,IndentBlock as mi,Link as gi,List as ui,MediaEmbed as fi,Paragraph as bi,PasteFromOffice as hi,Table as yi,TableToolbar as xi,TextTransformation as ki,CloudServices as Ti}from"ckeditor5";import{Alignment as Y,Autoformat as Z,Bold as ee,Italic as te,Underline as oe,BlockQuote as ae,CKBox as ie,CKBoxImageEdit as re,CloudServices as le,Essentials as se,FontBackgroundColor as ne,FontColor as de,FontFamily as ce,FontSize as pe,Heading as me,Indent as ge,IndentBlock as ue,PictureEditing as fe,Image as be,ImageCaption as he,ImageInsert as ye,ImageResize as xe,ImageStyle as ke,ImageToolbar as Te,ImageUpload as we,Link as Ie,List as Se,MediaEmbed as Ee,PageBreak as Ce,Paragraph as ve,PasteFromOffice as Le,SpecialCharacters as Pe,SpecialCharactersEssentials as _e,Table as De,TableCellProperties as Be,TableProperties as Re,TableToolbar as Ae,TextTransformation as Oe,CodeBlock as Fe,Mention as Ne,Plugin as Xi}from"ckeditor5";import{SourceEditingEnhanced as Me,ExportPdf as Ve,ExportWord as Ue,ImportWord as Ge,MergeFields as Ke,Template as He}from"ckeditor5-premium-features";var s="19.25mm",n="16mm",l=class extends r{static builtinPlugins=[...r.builtinPlugins,Ke,Ne,Y,se,Z,ae,ee,ie,re,Fe,me,fe,be,he,ke,Te,ge,te,Ie,Se,ve,De,Ae,Ve,Ue,Ge,pe,ce,de,ne,ue,we,ye,xe,Ee,Ce,Le,Pe,_e,Me,Re,Be,Oe,oe,le,He];static defaultConfig={mergeFields:{prefix:"{{",suffix:"}}",previewHtmlValues:!0,sanitizeHtml:t=>({html:t,hasChanged:!1}),definitions:[{groupId:"guestInformation",groupLabel:"Guest information",definitions:[{id:"guestTitle",label:"Title",defaultValue:"Mr./Mrs."},{id:"guestName",label:"Name",defaultValue:"John"},{id:"guestLastName",label:"Last name",defaultValue:"Doe"},{id:"discount",label:"Guest discount",defaultValue:"0%"},{id:"hotelRoomPhoto",label:"Hotel room photo",type:"image",width:600,height:400,defaultValue:"https://ckeditor.com/assets/images/ckdemo/merge-fields/hotel-room2.jpg"}]},{groupId:"reservationInformation",groupLabel:"Reservation information",definitions:[{id:"reservationNumber",label:"Reservation number",defaultValue:"0000"},{id:"arrivalDate",label:"Arrival date",defaultValue:()=>new Date().toLocaleDateString()},{id:"numberOfNights",label:"Number of nights",defaultValue:"0"},{id:"numberOfGuests",label:"Number of guests",defaultValue:"0"},{id:"roomType",label:"Room type",defaultValue:"Single room"},{id:"complimentaryDuration",label:"Complimentary duration",defaultValue:"60 min"},{id:"reservationDetails",label:"Reservation details",defaultValue:`
...
`,ji=[{id:"78900",label:"David Lee",values:{guestTitle:"Mr.",guestName:"David",guestLastName:"Lee",hotelRoomPhoto:"https://ckeditor.com/assets/images/ckdemo/merge-fields/hotel-room2.jpg",reservationNumber:"Y2JKH5G1Z",arrivalDate:new Date(2024,7,22).toLocaleDateString(),numberOfGuests:"2",numberOfNights:"6",roomType:"Double Room",discount:"20%",complimentaryDuration:"15 min",feedbackSurvey:'<a href="https://ckeditor.com/docs/ckeditor5/latest/features/merge-fields.html">quick survey</a>',resortPhone:"555-232-2334-23",reservationDetails:`
				<p style="text-align:center;"><strong>Reservation Details</strong></p>
				<figure class="table">
					<table>
						<tbody>
				...
				</figure>`}}];var qe={previewModes:["$labels"]};l.create({attachTo:document.querySelector("#snippet-merge-fields-labels"),mergeFields:{...l.defaultConfig.mergeFields,...qe},toolbar:{items:["insertMergeField"].concat(l.defaultConfig.toolbar.items),shouldNotGroupWhenFull:!0},root:{initialData:y}}).then(e=>{window.editor=e,window.preventPasteFromOfficeNotification=!0,p({target:m(e.ui.view.toolbar,t=>t.buttonView&&t.buttonView.label==="Insert merge field"),text:"Click to add a merge field.",editor:e,tippyOptions:{placement:"bottom-start"}})}).catch(e=>{console.error(e.stack)});
